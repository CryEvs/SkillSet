# 🦞 SkillSet — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/skillset/skillset/main/docs/assets/skillset-logo-text-dark.svg">
        <img src="https://raw.githubusercontent.com/skillset/skillset/main/docs/assets/skillset-logo-text.svg" alt="SkillSet" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/skillset/skillset/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/skillset/skillset/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/skillset/skillset/releases"><img src="https://img.shields.io/github/v/release/skillset/skillset?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**SkillSet** is a _personal AI assistant_ you run on your own devices.
...
[Website](https://skillset.ai) · [Docs](https://docs.skillset.ai) · [Vision](VISION.md) · [DeepWiki](https://deepwiki.com/skillset/skillset) · [Getting Started](https://docs.skillset.ai/start/getting-started) · [Updating](https://docs.skillset.ai/install/updating) · [Showcase](https://docs.skillset.ai/start/showcase) · [FAQ](https://docs.skillset.ai/help/faq) · [Onboarding](https://docs.skillset.ai/start/wizard) · [Nix](https://github.com/skillset/nix-skillset) · [Docker](https://docs.skillset.ai/install/docker) · [Discord](https://discord.gg/clawd)

New install? Start here: [Getting started](https://docs.skillset.ai/start/getting-started)

Preferred setup: run `skillset onboard` in your terminal.
SkillSet Onboard guides you step by step through setting up the gateway, workspace, channels, and skills. It is the recommended CLI setup path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
  ...
  <tr>
    <td align="center" width="16.66%">
      <a href="https://openai.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/skillset/skillset/main/docs/assets/sponsors/openai-light.svg">
          <img src="https://raw.githubusercontent.com/skillset/skillset/main/docs/assets/sponsors/openai.svg" alt="OpenAI" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://github.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/skillset/skillset/main/docs/assets/sponsors/github-light.svg">
          <img src="https://raw.githubusercontent.com/skillset/skillset/main/docs/assets/sponsors/github.svg" alt="GitHub" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.nvidia.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/skillset/skillset/main/docs/assets/sponsors/nvidia.svg">
          <img src="https://raw.githubusercontent.com/skillset/skillset/main/docs/assets/sponsors/nvidia-dark.svg" alt="NVIDIA" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://vercel.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/skillset/skillset/main/docs/assets/sponsors/vercel-light.svg">
          <img src="https://raw.githubusercontent.com/skillset/skillset/main/docs/assets/sponsors/vercel.svg" alt="Vercel" height="24">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://blacksmith.sh/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/skillset/skillset/main/docs/assets/sponsors/blacksmith-light.svg">
          <img src="https://raw.githubusercontent.com/skillset/skillset/main/docs/assets/sponsors/blacksmith.svg" alt="Blacksmith" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.convex.dev/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/skillset/skillset/main/docs/assets/sponsors/convex-light.svg">
          <img src="https://raw.githubusercontent.com/skillset/skillset/main/docs/assets/sponsors/convex.svg" alt="Convex" height="24">
        </picture>
      </a>
    </td>
  </tr>
...
Model note: while many providers and models are supported, prefer a current flagship model from the provider you trust and already use. See [Onboarding](https://docs.skillset.ai/start/onboarding).
...
# or: pnpm add -g skillset@latest

skillset onboard --install-daemon
```

SkillSet Onboard installs the Gateway daemon (launchd/systemd user service) so it stays running.

## Quick start (TL;DR)

Runtime: **Node 24 (recommended) or Node 22.16+**.

Full beginner guide (auth, pairing, channels): [Getting started](https://docs.skillset.ai/start/getting-started)

```bash
skillset onboard --install-daemon

skillset gateway --port 18789 --verbose

# Send a message
skillset message send --to +1234567890 --message "Hello from SkillSet"
...
skillset agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.skillset.ai/install/updating) (and run `skillset doctor`).

Models config + CLI: [Models](https://docs.skillset.ai/concepts/models). Auth profile rotation + fallbacks: [Model failover](https://docs.skillset.ai/concepts/model-failover).

## Security defaults (DM access)

SkillSet connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.skillset.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dmPolicy="pairing"` / `channels.slack.dmPolicy="pairing"`; legacy: `channels.discord.dm.policy`, `channels.slack.dm.policy`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `skillset pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.allowFrom` / `channels.slack.allowFrom`; legacy: `channels.discord.dm.allowFrom`, `channels.slack.dm.allowFrom`).

Run `skillset doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.skillset.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.skillset.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), IRC, Microsoft Teams, Matrix, Feishu, LINE, Mattermost, Nextcloud Talk, Nostr, Synology Chat, Tlon, Twitch, Zalo, Zalo Personal, WeChat, QQ, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.skillset.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.skillset.ai/nodes/voicewake) + [Talk Mode](https://docs.skillset.ai/nodes/talk)** — wake words on macOS/iOS and continuous voice on Android (ElevenLabs + system TTS fallback).
- **[Live Canvas](https://docs.skillset.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.skillset.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.skillset.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.skillset.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.skillset.ai/nodes).
- **[Onboarding](https://docs.skillset.ai/start/wizard) + [skills](https://docs.skillset.ai/tools/skills)** — onboarding-driven setup with bundled/managed/workspace skills.
...
- Before exposing anything remotely, read [Security](https://docs.skillset.ai/gateway/security), [Sandboxing](https://docs.skillset.ai/gateway/sandboxing), and [Configuration](https://docs.skillset.ai/gateway/configuration).
...
- Architecture overview: [Architecture](https://docs.skillset.ai/concepts/architecture)

## Docs by goal

- New here: [Getting started](https://docs.skillset.ai/start/getting-started), [Onboarding](https://docs.skillset.ai/start/wizard), [Updating](https://docs.skillset.ai/install/updating)
- Channel setup: [Channels index](https://docs.skillset.ai/channels), [WhatsApp](https://docs.skillset.ai/channels/whatsapp), [Telegram](https://docs.skillset.ai/channels/telegram), [Discord](https://docs.skillset.ai/channels/discord), [Slack](https://docs.skillset.ai/channels/slack)
- Apps + nodes: [macOS](https://docs.skillset.ai/platforms/macos), [iOS](https://docs.skillset.ai/platforms/ios), [Android](https://docs.skillset.ai/platforms/android), [Nodes](https://docs.skillset.ai/nodes)
- Config + security: [Configuration](https://docs.skillset.ai/gateway/configuration), [Security](https://docs.skillset.ai/gateway/security), [Sandboxing](https://docs.skillset.ai/gateway/sandboxing)
- Remote + web: [Gateway](https://docs.skillset.ai/gateway), [Remote access](https://docs.skillset.ai/gateway/remote), [Tailscale](https://docs.skillset.ai/gateway/tailscale), [Web surfaces](https://docs.skillset.ai/web)
- Tools + automation: [Tools](https://docs.skillset.ai/tools), [Skills](https://docs.skillset.ai/tools/skills), [Cron jobs](https://docs.skillset.ai/automation/cron-jobs), [Webhooks](https://docs.skillset.ai/automation/webhook), [Gmail Pub/Sub](https://docs.skillset.ai/automation/gmail-pubsub)
- Internals: [Architecture](https://docs.skillset.ai/concepts/architecture), [Agent](https://docs.skillset.ai/concepts/agent), [Session model](https://docs.skillset.ai/concepts/session), [Gateway protocol](https://docs.skillset.ai/reference/rpc)
- Troubleshooting: [Channel troubleshooting](https://docs.skillset.ai/channels/troubleshooting), [Logging](https://docs.skillset.ai/logging), [Docs home](https://docs.skillset.ai)
...
Note: signed builds required for macOS permissions to stick across rebuilds (see [macOS Permissions](https://docs.skillset.ai/platforms/mac/permissions)).

### iOS node (optional)

- Pairs as a node over the Gateway WebSocket (device pairing).
- Voice trigger forwarding + Canvas surface.
- Controlled via `skillset nodes …`.

Runbook: [iOS connect](https://docs.skillset.ai/platforms/ios).

### Android node (optional)

- Pairs as a WS node via device pairing (`skillset devices ...`).
- Exposes Connect/Chat/Voice tabs plus Canvas, Camera, Screen capture, and Android device command families.
- Runbook: [Android connect](https://docs.skillset.ai/platforms/android).
...
`pnpm skillset setup` writes the local config/workspace needed for `pnpm gateway:watch`. It is safe to re-run, but you normally only need it on first setup or after resetting local state. `pnpm gateway:watch` does not rebuild `dist/control-ui`, so rerun `pnpm ui:build` after `ui/` changes or use `pnpm ui:dev` when iterating on the Control UI. If you want this checkout to run onboarding directly, use `pnpm skillset onboard --install-daemon`.

Note: `pnpm skillset ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `skillset` binary, while `pnpm gateway:watch` rebuilds the runtime on demand during the dev loop.
...
Switch channels (git + npm): `skillset update --channel stable|beta|dev`.
Details: [Development channels](https://docs.skillset.ai/install/development-channels).

## Agent workspace + skills

- Workspace root: `~/.skillset/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.skillset/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.skillset/skillset.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.skillset.ai/gateway/configuration)

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=skillset/skillset&type=date&legend=top-left)](https://www.star-history.com/#skillset/skillset&type=date&legend=top-left)

## Molty

SkillSet was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [skillset.ai](https://skillset.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@skillset](https://x.com/skillset)
