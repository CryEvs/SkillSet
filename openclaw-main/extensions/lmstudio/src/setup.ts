...
import { withAgentModelAliases } from "skillset/plugin-sdk/provider-onboard";
import {
...
function stripLmstudioStoredAuthConfig(cfg: SkillSetConfig): SkillSetConfig {
...
function mergeDiscoveredLmstudioAllowlistEntries(params: {
  existing?: NonNullable<NonNullable<SkillSetConfig["agents"]>["defaults"]>["models"];
  discoveredModels: ModelDefinitionConfig[];
}) {
