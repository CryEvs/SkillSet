...
vi.mock("skillset/plugin-sdk/provider-auth-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("skillset/plugin-sdk/provider-auth-runtime")>();
  return {
    ...actual,
