...
import { collectIssuesForEnabledAccounts } from "skillset/plugin-sdk/status-helpers";
    ...
    collectIssues: ({ account, accountId, issues }) => {
      ...
      if (!configured) {
        issues.push({
          ...
          fix: "Run: skillset channels add bluebubbles --http-url <server-url> --password <password>",
        });
        return;
      }
