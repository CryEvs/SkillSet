...
const FEISHU_USER_AGENT = `skillset-feishu-builtin/${pluginVersion}/${process.platform}`;
...
export const FEISHU_HTTP_TIMEOUT_ENV_VAR = "SKILLSET_FEISHU_HTTP_TIMEOUT_MS";
