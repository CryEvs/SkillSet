...
} from "skillset/plugin-sdk/interactive-runtime";
...
export const feishuPlugin: ChannelPlugin<ResolvedFeishuAccount, FeishuProbeResult> =
  createChatChannelPlugin({
    base: {
      ...
      auth: {
        login: async ({ cfg }) => {
          const { createClackPrompter } = await import("skillset/plugin-sdk/setup-runtime");
          const { writeConfigFile } = await import("skillset/plugin-sdk/config-runtime");
