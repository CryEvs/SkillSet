...
import type { SkillSetPluginApi, SkillSetPluginToolContext } from "../runtime-api.js";
import { createLobsterTool } from "./lobster-tool.js";
import { createFakeTaskFlow } from "./taskflow-test-helpers.js";

function fakeApi(overrides: Partial<SkillSetPluginApi> = {}): SkillSetPluginApi {
...
function fakeCtx(overrides: Partial<SkillSetPluginToolContext> = {}): SkillSetPluginToolContext {
  return {
    config: {},
    workspaceDir: "/tmp",
    agentDir: "/tmp",
...
describe("lobster plugin tool", () => {
  ...
  it("can be gated off in sandboxed contexts", async () => {
    const api = fakeApi();
    const factoryTool = (ctx: SkillSetPluginToolContext) => {
      if (ctx.sandboxed) {
        return null;
      }
