...
import { mapPluginConfigIssues } from "skillset/plugin-sdk/extension-shared";
import { buildPluginConfigSchema, z, type SkillSetPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: SkillSetPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".skillset", "wiki", "main");
}
