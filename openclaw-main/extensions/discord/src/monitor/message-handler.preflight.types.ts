...
import type { SessionBindingRecord } from "skillset/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "skillset/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "skillset/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("skillset/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("skillset/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("skillset/plugin-sdk/config-runtime").SkillSetConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
