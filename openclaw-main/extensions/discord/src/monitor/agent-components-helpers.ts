...
import { resolveCommandAuthorizedFromAuthorizers } from "skillset/plugin-sdk/command-auth-native";
import type { DiscordAccountConfig, SkillSetConfig } from "skillset/plugin-sdk/config-runtime";
...
import { logError } from "skillset/plugin-sdk/text-runtime";
import {
