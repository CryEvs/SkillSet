...
vi.mock("skillset/plugin-sdk/retry-runtime", async () => {
  const actual = await vi.importActual<typeof import("skillset/plugin-sdk/retry-runtime")>(
    "skillset/plugin-sdk/retry-runtime",
  );
  return {
    ...actual,
