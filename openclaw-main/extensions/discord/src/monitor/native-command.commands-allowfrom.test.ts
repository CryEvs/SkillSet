...
import type { DiscordAccountConfig } from "skillset/plugin-sdk/config-runtime";
import * as pluginCommandsModule from "skillset/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "skillset/plugin-sdk/reply-dispatch-runtime";
...
function createCommand(cfg: SkillSetConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: SkillSetConfig) => void;
