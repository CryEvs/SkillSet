...
import type { NativeCommandSpec } from "skillset/plugin-sdk/command-auth";
...
import { dispatchReplyWithDispatcher } from "skillset/plugin-sdk/reply-dispatch-runtime";
...
function createConfig(): SkillSetConfig {
  return {
    channels: {
      discord: {
...
async function createNativeCommand(cfg: SkillSetConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: SkillSetConfig; name: string }) {
  return createDiscordNativeCommand({
    command: {
      name: params.name,
      description: "Pair",
...
async function createStatusCommand(cfg: SkillSetConfig) {
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(() => {
    ...
    discordNativeCommandTesting.setMatchPluginCommand(
      runtimeModuleMocks.matchPluginCommand as typeof import("skillset/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
    discordNativeCommandTesting.setExecutePluginCommand(
      runtimeModuleMocks.executePluginCommand as typeof import("skillset/plugin-sdk/plugin-runtime").executePluginCommand,
    );
