...
import { CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "skillset/plugin-sdk/approval-handler-adapter-runtime";
import type { ChannelRuntimeSurface } from "skillset/plugin-sdk/channel-contract";
import { registerChannelRuntimeContext } from "skillset/plugin-sdk/channel-runtime-context";
import {
...
import type { SkillSetConfig, ReplyToMode } from "skillset/plugin-sdk/config-runtime";
import { loadConfig } from "skillset/plugin-sdk/config-runtime";
import { createConnectedChannelStatusPatch } from "skillset/plugin-sdk/gateway-runtime";
import { getPluginCommandSpecs } from "skillset/plugin-sdk/plugin-runtime";
import { resolveTextChunkLimit } from "skillset/plugin-sdk/reply-chunking";
import {
  danger,
  isVerbose,
  logVerbose,
...
} from "skillset/plugin-sdk/runtime-group-policy";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("skillset/plugin-sdk/reply-history").HistoryEntry[]
    >();
