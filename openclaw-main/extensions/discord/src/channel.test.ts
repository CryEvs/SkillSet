...
function createCfg(): SkillSetConfig {
  return {
    channels: {
      discord: {
        enabled: true,
...
function resolveAccount(cfg: SkillSetConfig, accountId = "default"): ResolvedDiscordAccount {
  return discordPlugin.config.resolveAccount(cfg, accountId);
}

function startDiscordAccount(cfg: SkillSetConfig, accountId = "default") {
