...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("skillset.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("skillset.discord.modalEntries");
