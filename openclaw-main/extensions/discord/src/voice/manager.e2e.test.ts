...
vi.mock("skillset/plugin-sdk/routing", async () => {
  const actual = await vi.importActual<typeof import("skillset/plugin-sdk/routing")>(
    "skillset/plugin-sdk/routing",
  );
  return {
    ...actual,
...
vi.mock("skillset/plugin-sdk/agent-runtime", async () => {
  const actual = await vi.importActual<typeof import("skillset/plugin-sdk/agent-runtime")>(
    "skillset/plugin-sdk/agent-runtime",
  );
  return {
    ...actual,
