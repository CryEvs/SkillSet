...
} from "skillset/plugin-sdk/allowlist-config-edit";
import type {
...
import { createLazyRuntimeModule } from "skillset/plugin-sdk/lazy-runtime";
import { resolveOutboundSendDep } from "skillset/plugin-sdk/outbound-runtime";
import { sleepWithAbort } from "skillset/plugin-sdk/runtime-env";
import {
  createComputedAccountStatusAdapter,
  createDefaultChannelRuntimeState,
} from "skillset/plugin-sdk/status-helpers";
import { resolveTargetsWithOptionalToken } from "skillset/plugin-sdk/target-resolver-runtime";
import {
...
function resolveDiscordStartupDelayMs(cfg: SkillSetConfig, accountId: string): number {
    ...
    base: {
      ...
      agentPrompt: {
        messageToolHints: () => [
          ...
          "- Forms: add `components.modal` (title, fields). SkillSet adds a trigger button and routes submissions as new messages.",
        ],
      },
      messaging: {
