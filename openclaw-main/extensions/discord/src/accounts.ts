...
import type { DiscordAccountConfig, DiscordActionConfig, SkillSetConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: SkillSetConfig): ResolvedDiscordAccount[] {
