...
const providerMonitorTestMocks: ProviderMonitorTestMocks = vi.hoisted(() => {
  ...
  return {
    ...
    getAcpSessionStatusMock: vi.fn(
      async (_params: { cfg: SkillSetConfig; sessionKey: string; signal?: AbortSignal }) => ({
        state: "idle",
      }),
    ),
...
export const baseConfig = (): SkillSetConfig =>
  ({
    channels: {
      discord: {
        accounts: {
...
vi.mock("skillset/plugin-sdk/acp-runtime", async () => {
  const actual = await vi.importActual<typeof import("skillset/plugin-sdk/acp-runtime")>(
    "skillset/plugin-sdk/acp-runtime",
  );
  return {
    ...actual,
...
vi.mock("skillset/plugin-sdk/command-auth", async () => {
  const actual = await vi.importActual<typeof import("skillset/plugin-sdk/command-auth")>(
    "skillset/plugin-sdk/command-auth",
  );
  return {
    ...actual,
...
vi.mock("skillset/plugin-sdk/reply-runtime", async () => {
  const actual = await vi.importActual<typeof import("skillset/plugin-sdk/reply-runtime")>(
...
vi.mock("skillset/plugin-sdk/config-runtime", async () => {
  const actual = await vi.importActual<typeof import("skillset/plugin-sdk/config-runtime")>(
    "skillset/plugin-sdk/config-runtime",
  );
  return {
    ...actual,
...
vi.mock("skillset/plugin-sdk/runtime-env", async () => {
  const actual = await vi.importActual<typeof import("skillset/plugin-sdk/runtime-env")>(
    "skillset/plugin-sdk/runtime-env",
  );
  return {
    ...actual,
...
vi.mock("skillset/plugin-sdk/infra-runtime", async () => {
  const actual = await vi.importActual<typeof import("skillset/plugin-sdk/infra-runtime")>(
    "skillset/plugin-sdk/infra-runtime",
  );
  return {
    ...actual,
