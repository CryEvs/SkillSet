...
function mergeSignalAccountConfig(cfg: SkillSetConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: SkillSetConfig): ResolvedSignalAccount[] {
