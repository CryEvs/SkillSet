import type { resolveProviderHttpRequestConfig } from "skillset/plugin-sdk/provider-http";
...
vi.mock("skillset/plugin-sdk/provider-auth-runtime", () => ({
  resolveApiKeyForProvider: minimaxProviderHttpMocks.resolveApiKeyForProviderMock,
}));

vi.mock("skillset/plugin-sdk/provider-http", () => ({
