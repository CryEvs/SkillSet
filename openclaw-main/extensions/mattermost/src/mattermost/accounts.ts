import { createAccountListHelpers } from "skillset/plugin-sdk/account-helpers";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "skillset/plugin-sdk/account-id";
import { resolveMergedAccountConfig } from "skillset/plugin-sdk/account-resolution";
import {
...
export function listMattermostAccountIds(cfg: SkillSetConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: SkillSetConfig): string {
...
export function listEnabledMattermostAccounts(cfg: SkillSetConfig): ResolvedMattermostAccount[] {
