import { createClaimableDedupe } from "skillset/plugin-sdk/persistent-dedupe";
...
function evaluateMentionGateForMessage(params: { cfg: SkillSetConfig; threadRootId?: string }) {
