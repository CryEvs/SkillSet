import { requireRuntimeConfig, resolveMarkdownTableMode } from "skillset/plugin-sdk/config-runtime";
...
import { loadOutboundMediaFromUrl, type SkillSetConfig } from "./runtime-api.js";
