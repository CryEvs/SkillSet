...
import type { ChunkMode } from "skillset/plugin-sdk/reply-runtime";
import { describe, expect, it, vi } from "vitest";
import type { SkillSetConfig, PluginRuntime } from "../../runtime-api.js";
...
describe("deliverMattermostReplyPayload", () => {
  it("suppresses payloads flagged as reasoning", async () => {
    ...
    const cfg = {} satisfies SkillSetConfig;
  ...
  it("passes agent-scoped mediaLocalRoots when sending media paths", async () => {
    ...
    const stateDir = await fs.mkdtemp(path.join(os.tmpdir(), "skillset-mm-state-"));
