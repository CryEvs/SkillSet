import type { ChannelSetupAdapter } from "skillset/plugin-sdk/channel-setup";
import { createSetupInputPresenceValidator } from "skillset/plugin-sdk/setup-runtime";
import {
...
export function resolveMattermostAccountWithSecrets(cfg: SkillSetConfig, accountId: string) {
