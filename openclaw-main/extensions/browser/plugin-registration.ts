...
export const browserPluginNodeHostCommands: SkillSetPluginNodeHostCommand[] = [
  {
...
export function registerBrowserPlugin(api: SkillSetPluginApi) {
  api.registerTool(((ctx: SkillSetPluginToolContext) =>
    createBrowserTool({
