...
} from "skillset/plugin-sdk/browser-node-runtime";
...
export function createBrowserPluginService(): SkillSetPluginService {
  ...
  return {
    ...
    start: async () => {
      ...
      handle = await startLazyPluginServiceModule({
        skipEnvVar: "SKILLSET_SKIP_BROWSER_CONTROL_SERVER",
        overrideEnvVar: "SKILLSET_BROWSER_CONTROL_MODULE",
