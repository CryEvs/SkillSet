...
describe("prepareOpenAICodexCliExecution", () => {
  ...
  it("writes a private CODEX_HOME bridge from canonical SkillSet oauth", async () => {
    const agentDir = await fs.mkdtemp(path.join(os.tmpdir(), "skillset-codex-cli-bridge-"));
