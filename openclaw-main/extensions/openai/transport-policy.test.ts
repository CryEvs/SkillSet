import type { ProviderRuntimeModel } from "skillset/plugin-sdk/plugin-entry";
  ...
  it("builds native turn state for direct OpenAI routes", () => {
    expect(
      ...
      headers: {
        ...
        "x-skillset-session-id": "session-123",
        "x-skillset-turn-id": "turn-123",
        "x-skillset-turn-attempt": "2",
      },
      metadata: {
        skillset_session_id: "session-123",
        skillset_turn_id: "turn-123",
        skillset_turn_attempt: "2",
        skillset_transport: "websocket",
      },
    });
  });
