...
vi.mock("skillset/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("skillset/plugin-sdk/channel-pairing", () => ({
...
vi.mock("skillset/plugin-sdk/command-auth", () => ({
...
vi.mock("skillset/plugin-sdk/config-runtime", () => ({
...
vi.mock("skillset/plugin-sdk/group-access", () => ({
...
vi.mock("skillset/plugin-sdk/routing", () => ({
