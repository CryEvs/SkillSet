...
import { WEBHOOK_IN_FLIGHT_DEFAULTS } from "skillset/plugin-sdk/webhook-request-guards";
...
vi.mock("skillset/plugin-sdk/reply-runtime", () => ({
...
vi.mock("skillset/plugin-sdk/webhook-ingress", () => ({
