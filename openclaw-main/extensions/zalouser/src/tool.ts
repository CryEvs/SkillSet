import type { AnyAgentTool, SkillSetPluginToolContext } from "skillset/plugin-sdk/core";
...
type ZalouserToolContext = Pick<SkillSetPluginToolContext, "deliveryContext">;
