...
Nostr DM channel plugin for SkillSet using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to SkillSet. It enables your bot to:
...
# Configure skillset to use local relay
