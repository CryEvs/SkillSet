...
const providerFilter = parseCsvFilter(process.env.SKILLSET_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.SKILLSET_LIVE_MUSIC_GENERATION_MODELS);
