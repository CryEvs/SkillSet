import { buildPluginConfigSchema } from "skillset/plugin-sdk/core";
import { z } from "skillset/plugin-sdk/zod";
import type { SkillSetPluginConfigSchema } from "../runtime-api.js";
...
export function createAcpxPluginConfigSchema(): SkillSetPluginConfigSchema {
