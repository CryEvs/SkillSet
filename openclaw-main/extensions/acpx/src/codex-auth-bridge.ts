...
import { resolveSkillSetAgentDir } from "skillset/plugin-sdk/provider-auth";
import { prepareCodexAuthBridge } from "skillset/plugin-sdk/provider-auth-runtime";
import { writePrivateSecretFileAtomic } from "skillset/plugin-sdk/secret-file-runtime";
import type { PluginLogger } from "../runtime-api.js";
import type { ResolvedAcpxPluginConfig } from "./config.js";

const CODEX_AGENT_ID = "codex";
const DEFAULT_CODEX_AUTH_PROFILE_ID = "openai-codex:default";
// acpx selects ACP auth methods from the SkillSet process env before the wrapper
