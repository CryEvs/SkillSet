...
vi.mock("skillset/plugin-sdk/outbound-media", () => ({
...
describe("zalo outbound hosted media", () => {
  ...
  it("loads outbound media under SkillSet control and returns a hosted URL", async () => {
  ...
  it("creates hosted media storage with private filesystem permissions", async () => {
    ...
    const storageDir = join(resolvePreferredSkillSetTmpDir(), "skillset-zalo-outbound-media");
