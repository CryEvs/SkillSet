...
function mergeIMessageAccountConfig(cfg: SkillSetConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: SkillSetConfig): ResolvedIMessageAccount[] {
