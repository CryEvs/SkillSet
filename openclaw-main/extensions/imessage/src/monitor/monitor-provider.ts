...
import { createChannelPairingChallengeIssuer } from "skillset/plugin-sdk/channel-pairing";
...
import { normalizeScpRemoteHost } from "skillset/plugin-sdk/host-runtime";
import { waitForTransportReady } from "skillset/plugin-sdk/infra-runtime";
import { isInboundPathAllowed, kindFromMime } from "skillset/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "skillset/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "skillset/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "skillset/plugin-sdk/reply-runtime";
import { createReplyDispatcher } from "skillset/plugin-sdk/reply-runtime";
import { danger, logVerbose, shouldLogVerbose, warn } from "skillset/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "skillset/plugin-sdk/security-runtime";
import { truncateUtf16Safe } from "skillset/plugin-sdk/text-runtime";
 ...
 *   exec ssh -T skillset@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., skillset@192.168.64.3)
