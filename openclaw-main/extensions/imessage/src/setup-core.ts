...
export const imessageDmPolicy = {
  ...
  resolveConfigKeys: (_cfg: SkillSetConfig, accountId?: string) => {
  ...
  getCurrent: (cfg: SkillSetConfig, accountId?: string) => {
...
function resolveIMessageCliPath(params: { cfg: SkillSetConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure SkillSet has Full Disk Access to Messages DB.",
...
export const imessageSetupStatusBase = {
  ...
  configuredScore: 1,
  unconfiguredScore: 0,
  resolveConfigured: ({ cfg, accountId }: { cfg: SkillSetConfig; accountId?: string }) =>
