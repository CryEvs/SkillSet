...
export function resolveLegacyXSearchConfig(config?: SkillSetConfig): JsonRecord | undefined {
...
export function resolvePluginXSearchConfig(config?: SkillSetConfig): JsonRecord | undefined {
...
export function resolveEffectiveXSearchConfig(config?: SkillSetConfig): JsonRecord | undefined {
