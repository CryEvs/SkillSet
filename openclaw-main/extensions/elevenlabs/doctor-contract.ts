import type { ChannelDoctorLegacyConfigRule } from "skillset/plugin-sdk/channel-contract";
import type { SkillSetConfig } from "skillset/plugin-sdk/config-runtime";
import { isRecord } from "skillset/plugin-sdk/text-runtime";
...
export function normalizeCompatibilityConfig({ cfg }: { cfg: SkillSetConfig }): {
