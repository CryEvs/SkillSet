import { DEFAULT_ACCOUNT_ID, type SkillSetConfig } from "skillset/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "skillset/plugin-sdk/webhook-ingress";
