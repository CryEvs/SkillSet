...
import {
  ...
  type SkillSetConfig,
} from "skillset/plugin-sdk/account-resolution";
import { resolveDangerousNameMatchingEnabled } from "skillset/plugin-sdk/dangerous-name-runtime";
import type {
...
/** Extract the channel config from the full SkillSet config object. */
function getChannelConfig(cfg: SkillSetConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: SkillSetConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.SKILLSET_BOT_NAME ?? "SkillSet";
