...
vi.mock("skillset/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("skillset/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("skillset/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("skillset/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("skillset/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("skillset/plugin-sdk/webhook-ingress");
  return {
    ...actual,
