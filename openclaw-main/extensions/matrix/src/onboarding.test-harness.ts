import type { OutputRuntimeEnv } from "skillset/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "skillset/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "SkillSet Gateway",
    },
    confirm: {
