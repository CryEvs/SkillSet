...
import { adaptScopedAccountAccessor } from "skillset/plugin-sdk/channel-config-helpers";
import {
...
import { buildOutboundBaseSessionKey, type RoutePeer } from "skillset/plugin-sdk/routing";
import {
...
//
// `skillset/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "skillset/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "skillset/plugin-sdk/target-resolver-runtime";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as SkillSetConfig, toolContext as SlackActionContext | undefined),
    }),
