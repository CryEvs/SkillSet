...
vi.mock("skillset/plugin-sdk/channel-feedback", () => ({
  DEFAULT_TIMING: {
    doneHoldMs: 0,
    errorHoldMs: 0,
  },
...
vi.mock("skillset/plugin-sdk/channel-reply-pipeline", () => ({
...
vi.mock("skillset/plugin-sdk/channel-streaming", () => ({
...
vi.mock("skillset/plugin-sdk/outbound-runtime", () => ({
  resolveAgentOutboundIdentity: () => undefined,
}));

vi.mock("skillset/plugin-sdk/reply-history", () => ({
  clearHistoryEntriesIfEnabled: () => {},
}));

vi.mock("skillset/plugin-sdk/reply-payload", () => ({
...
vi.mock("skillset/plugin-sdk/security-runtime", () => ({
  resolvePinnedMainDmOwnerFromAllowlist: () => undefined,
}));

vi.mock("skillset/plugin-sdk/text-runtime", () => ({
...
vi.mock("../config.runtime.js", () => ({
  resolveStorePath: () => "/tmp/skillset-store.json",
