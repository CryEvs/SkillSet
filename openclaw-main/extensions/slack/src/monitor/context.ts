...
import type { SessionScope } from "skillset/plugin-sdk/config-runtime";
import type { DmPolicy, GroupPolicy } from "skillset/plugin-sdk/config-runtime";
import { formatErrorMessage } from "skillset/plugin-sdk/error-runtime";
import { createDedupeCache } from "skillset/plugin-sdk/infra-runtime";
import type { HistoryEntry } from "skillset/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("skillset/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
