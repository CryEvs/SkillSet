...
import { definePluginEntry, type ProviderAuthContext } from "skillset/plugin-sdk/plugin-entry";
import { ensureAuthProfileStore } from "skillset/plugin-sdk/provider-auth";
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    function resolveCurrentPluginConfig(config?: SkillSetConfig): GithubCopilotPluginConfig {
