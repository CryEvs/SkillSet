...
import { safeParseJsonWithSchema, safeParseWithSchema } from "skillset/plugin-sdk/extension-shared";
import { isSecretRef } from "skillset/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: SkillSetConfig): ResolvedGoogleChatAccount[] {
