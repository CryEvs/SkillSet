...
import type { SkillSetPluginApi, PluginCommandContext } from "skillset/plugin-sdk/plugin-entry";
...
export function registerQQBotFrameworkCommands(api: SkillSetPluginApi): void {
