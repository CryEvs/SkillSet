import { assertOkOrThrowHttpError, postJsonRequest } from "skillset/plugin-sdk/provider-http";
import type { SkillSetConfig } from "skillset/plugin-sdk/provider-onboard";
...
} from "skillset/plugin-sdk/speech-core";
import { asObject, trimToUndefined } from "skillset/plugin-sdk/speech-core";
...
function resolveGoogleTtsModelProviderApiKey(cfg?: SkillSetConfig): string | undefined {
