...
vi.mock("skillset/plugin-sdk/config-runtime", async () => {
  const original = (await vi.importActual("skillset/plugin-sdk/config-runtime")) as Record<
    string,
    unknown
  >;
  return {
...
vi.mock("skillset/plugin-sdk/text-runtime", async () => {
  const original = (await vi.importActual("skillset/plugin-sdk/text-runtime")) as Record<
    string,
    unknown
  >;
  return {
