...
function resolveSkillSetVersion(): string {
  try {
 ...
 * and appends the SkillSet version.
 *
 * Format: "teams.ts[apps]/<sdk-version> SkillSet/<skillset-version>"
 * Example: "teams.ts[apps]/2.0.5 SkillSet/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} SkillSet/${resolveSkillSetVersion()}`;
  return cachedUserAgent;
}
