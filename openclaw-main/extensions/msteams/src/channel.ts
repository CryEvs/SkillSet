import { describeAccountSnapshot } from "skillset/plugin-sdk/account-helpers";
import { formatAllowFromLowercase } from "skillset/plugin-sdk/allow-from";
import { createTopLevelChannelConfigAdapter } from "skillset/plugin-sdk/channel-config-helpers";
import type {
  ChannelMessageActionAdapter,
  ChannelMessageToolDiscovery,
} from "skillset/plugin-sdk/channel-contract";
import { createChatChannelPlugin } from "skillset/plugin-sdk/channel-core";
import { createPairingPrefixStripper } from "skillset/plugin-sdk/channel-pairing";
import {
...
} from "skillset/plugin-sdk/directory-runtime";
import { normalizeMessagePresentation } from "skillset/plugin-sdk/interactive-runtime";
import { createLazyRuntimeNamedExport } from "skillset/plugin-sdk/lazy-runtime";
import { createRuntimeOutboundDelegates } from "skillset/plugin-sdk/outbound-runtime";
import { createComputedAccountStatusAdapter } from "skillset/plugin-sdk/status-helpers";
import { normalizeOptionalString } from "skillset/plugin-sdk/text-runtime";
import { Type } from "typebox";
import type { ChannelMessageActionName, ChannelPlugin, SkillSetConfig } from "../runtime-api.js";
import {
...
const resolveMSTeamsChannelConfig = (cfg: SkillSetConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: SkillSetConfig }>(
