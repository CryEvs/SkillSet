...
import { buildPluginConfigSchema, type SkillSetPluginConfigSchema } from "skillset/plugin-sdk/core";
import {
...
export function createOpenShellPluginConfigSchema(): SkillSetPluginConfigSchema {
