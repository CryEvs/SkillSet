...
import type { BaseTokenResolution } from "skillset/plugin-sdk/channel-contract";
import { tryReadSecretFileSync } from "skillset/plugin-sdk/channel-core";
...
import { resolveDefaultSecretProviderAlias } from "skillset/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "skillset/plugin-sdk/routing";
import {
...
function resolveEnvSecretRefValue(params: {
  cfg?: Pick<SkillSetConfig, "secrets">;
  provider: string;
  id: string;
