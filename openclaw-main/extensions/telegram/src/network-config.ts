...
import { isTruthyEnvValue, isWSL2Sync } from "skillset/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "skillset/plugin-sdk/text-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "SKILLSET_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "SKILLSET_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "SKILLSET_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable SKILLSET_TELEGRAM_DNS_RESULT_ORDER
