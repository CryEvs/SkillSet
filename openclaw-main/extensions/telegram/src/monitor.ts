...
import { resolveAgentMaxConcurrent } from "skillset/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "skillset/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: SkillSetConfig): RunOptions<unknown> {
  return {
    sink: {
