...
const TEST_CACHE_DIR = "/tmp/skillset-test-sticker-cache/telegram";
const TEST_CACHE_FILE = path.join(TEST_CACHE_DIR, "sticker-cache.json");

describe("sticker-cache", () => {
  beforeEach(() => {
    process.env.SKILLSET_STATE_DIR = "/tmp/skillset-test-sticker-cache";
    fs.rmSync("/tmp/skillset-test-sticker-cache", { recursive: true, force: true });
