...
import type { ChannelMessageActionAdapter } from "skillset/plugin-sdk/channel-contract";
import {
...
import { createAccountStatusSink } from "skillset/plugin-sdk/channel-lifecycle";
import { createPairingPrefixStripper } from "skillset/plugin-sdk/channel-pairing";
import { attachChannelToResult } from "skillset/plugin-sdk/channel-send-result";
import {
...
import { type RoutePeer } from "skillset/plugin-sdk/routing";
import {
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as SkillSetConfig;
