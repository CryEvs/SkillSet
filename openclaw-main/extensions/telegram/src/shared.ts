import { resolveNormalizedAccountEntry } from "skillset/plugin-sdk/account-core";
...
import { createChannelPluginBase, type ChannelPlugin } from "skillset/plugin-sdk/channel-core";
import { getChatChannelMeta } from "skillset/plugin-sdk/channel-plugin-common";
 ...
 *
 * See: https://github.com/skillset/skillset/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: SkillSetConfig, accountId: string): boolean {
