...
import { isAbortRequestText, type ReplyPayload } from "skillset/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: SkillSetConfig, agentId: string) {
  try {
