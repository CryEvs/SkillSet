import { resolveAccountWithDefaultFallback } from "skillset/plugin-sdk/account-core";
...
import { coerceSecretRef } from "skillset/plugin-sdk/config-runtime";
...
function inspectTokenValue(params: { cfg: SkillSetConfig; value: unknown }): {
  token: string;
