...
import { dispatchInboundReplyWithBase } from "skillset/plugin-sdk/inbound-reply-dispatch";
import {
...
export async function handleQaInbound(params: {
  ...
  const route = runtime.channel.routing.resolveAgentRoute({
    cfg: params.config as SkillSetConfig,
  ...
  const body = runtime.channel.reply.formatAgentEnvelope({
    ...
    previousTimestamp,
    envelope: runtime.channel.reply.resolveEnvelopeFormatOptions(params.config as SkillSetConfig),
    body: inbound.text,
  });
