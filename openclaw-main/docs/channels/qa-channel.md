---
title: "QA Channel"
summary: "Synthetic Slack-class channel plugin for deterministic SkillSet QA scenarios"
read_when:
...
`qa-channel` is a bundled synthetic message transport for automated SkillSet QA.
...
- SkillSet-native orchestration later
