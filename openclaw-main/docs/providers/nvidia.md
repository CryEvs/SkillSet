---
summary: "Use NVIDIA's OpenAI-compatible API in SkillSet"
read_when:
  - You want to use open models in SkillSet for free
...
<Steps>
  ...
  <Step title="Export the key and run onboarding">
    ...
    skillset onboard --auth-choice skip
    ```
  </Step>
  <Step title="Set an NVIDIA model">
    ```bash
    skillset models set nvidia/nvidia/nemotron-3-super-120b-a12b
    ```
  </Step>
</Steps>
