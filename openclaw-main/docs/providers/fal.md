---
title: "fal"
summary: "fal image and video generation setup in SkillSet"
read_when:
  - You want to use fal image generation in SkillSet
...
SkillSet ships a bundled `fal` provider for hosted image and video generation.
...
<Steps>
  <Step title="Set the API key">
    ```bash
    skillset onboard --auth-choice fal-api-key
    ```
  </Step>
...
<Tip>
Use `skillset models list --provider fal` to see the full list of available fal
