...
read_when:
  - You want to use Together AI with SkillSet
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    skillset onboard --auth-choice together-api-key
    ```
  </Step>
...
SkillSet ships this bundled Together catalog:
...
<AccordionGroup>
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `skillset models list --provider together`
