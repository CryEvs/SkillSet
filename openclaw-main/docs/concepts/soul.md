---
summary: "Use SOUL.md to give your SkillSet agent an actual voice instead of generic assistant sludge"
read_when:
...
SkillSet injects it on normal sessions, so it has real weight. If your agent
...
For SkillSet, `SOUL.md` is that layer.
...
Path fixed for SkillSet workspaces: use `SOUL.md`, not `http://SOUL.md`.
