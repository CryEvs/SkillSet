...
summary: "What experimental flags mean in SkillSet and which ones are currently documented"
read_when:
...
Experimental features in SkillSet are **opt-in preview surfaces**. They are
...
- If you are rolling SkillSet out broadly, test experimental flags in a smaller
...
| ------------------------ | --------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| Local model runtime      | `agents.defaults.experimental.localModelLean`             | A smaller or stricter local backend chokes on SkillSet's full default tool surface                             | [Local Models](/gateway/local-models)                                                         |
...
If a feature is experimental, SkillSet should say so plainly in docs and in the
