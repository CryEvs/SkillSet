---
summary: "Overview of SkillSet onboarding options and flows"
read_when:
...
SkillSet has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `skillset onboard`                     | Launch the app            |
...
CLI command docs: [`skillset onboard`](/cli/onboard)

## macOS app onboarding

Open the SkillSet app. The first-run wizard walks you through the same steps
