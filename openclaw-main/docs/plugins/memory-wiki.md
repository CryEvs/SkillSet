...
If the active memory plugin exposes shared recall artifacts, SkillSet can search
...
currently exposing public bridge inputs yet. Run `skillset wiki doctor` first,
...
skillset wiki apply synthesis "Alpha Summary" --body "..." --source-id source.alpha
