...
This hub links the core docs for how SkillSet connects, pairs, and secures
devices across localhost, LAN, and tailnet.

## Core model

Most operations flow through the Gateway (`skillset gateway`), a single long-running process that owns channel connections and the WebSocket control plane.
...
- **Canvas host** is served on the same port as the Gateway (`/__skillset__/canvas/`, `/__skillset__/a2ui/`), protected by Gateway auth when bound beyond loopback.
