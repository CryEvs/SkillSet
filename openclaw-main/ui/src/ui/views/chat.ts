            ...
            ${att.mimeType.startsWith("audio/")
              ? html`
                  <div class="chat-attachment-audio">
                    <span class="chat-attachment-audio__icon">${icons.mic}</span>
                    <audio controls preload="metadata" src=${att.dataUrl}></audio>
                  </div>
                `
          ...
          (item) => {
            ...
            if (item.kind === "group") {
              ...
              return renderMessageGroup(item, {
                ...
                onCreatePlannerTasks: props.onCreatePlannerTasks,
                contextWindow:
