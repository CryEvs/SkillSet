...
declare global {
  interface Window {
    __SKILLSET_CONTROL_UI_BASE_PATH__?: string;
  }
}
...
@customElement("skillset-app")
export class SkillSetApp extends LitElement {
...
if (!customElements.get("skillset-app")) {
  customElements.define("skillset-app", SkillSetApp);
}
