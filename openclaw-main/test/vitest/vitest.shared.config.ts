...
export type SkillSetVitestPool = "forks" | "threads";
...
export function resolveLocalVitestMaxWorkers(
  ...
  pool: SkillSetVitestPool = resolveDefaultVitestPool(env),
): number {
...
export const sharedVitestConfig = {
  ...
  resolve: {
    alias: [
      {
        find: "skillset/extension-api",
        replacement: path.join(repoRoot, "src", "extensionAPI.ts"),
      },
      ...pluginSdkSubpaths.map((subpath) => ({
        find: `skillset/plugin-sdk/${subpath}`,
