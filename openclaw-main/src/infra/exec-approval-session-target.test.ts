...
function resolveSlackPluginOriginTarget(params: { cfg: SkillSetConfig; turnSourceTo: string }) {
...
describe("exec approval session target", () => {
  ...
  it("returns null for blank session keys, missing entries, and unresolved targets", () => {
    withTempDirSync({ prefix: "skillset-exec-approval-session-target-" }, (tmpDir) => {
