  ...
  return withEnvAsync(
    {
      ...
      SKILLSET_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when SKILLSET_VERSION is not set", async () => {
  ...
  it("prefers SKILLSET_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over SKILLSET_SERVICE_VERSION when SKILLSET_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        SKILLSET_VERSION: " ",
        SKILLSET_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when SKILLSET_VERSION and SKILLSET_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        SKILLSET_VERSION: " ",
        SKILLSET_SERVICE_VERSION: "\t",
