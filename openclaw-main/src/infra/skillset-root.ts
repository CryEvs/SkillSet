...
import { openClawRootFs, openClawRootFsSync } from "./skillset-root.fs.runtime.js";

const CORE_PACKAGE_NAMES = new Set(["skillset"]);
...
export async function resolveSkillSetPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveSkillSetPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
