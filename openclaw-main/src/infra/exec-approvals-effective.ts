...
const DEFAULT_HOST_PATH = "~/.skillset/exec-approvals.json";
...
function formatRequestedSource(params: {
  ...
  return params.sourcePath === "__default__"
    ? `SkillSet default (${params.defaultValue})`
...
function formatHostFieldSource(params: {
  ...
  if (params.field === "askFallback") {
    return `SkillSet default (${DEFAULT_EXEC_APPROVAL_ASK_FALLBACK})`;
  }
