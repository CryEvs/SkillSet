...
export const DEFAULT_RESTART_SUCCESS_CONTINUATION_MESSAGE =
  "The gateway restart completed successfully. Tell the user SkillSet restarted successfully and continue any pending work.";
...
export function formatDoctorNonInteractiveHint(
  ...
  return `Run: ${formatCliCommand("skillset doctor --non-interactive", env)}`;
}
