...
const CLEANUP_STATE_KEY = Symbol.for("skillset.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("skillset.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("skillset.sessionWriteLockWatchdogState");
...
function shouldStartBackgroundWatchdog(): boolean {
  return process.env.VITEST !== "true" || process.env.SKILLSET_TEST_SESSION_LOCK_WATCHDOG === "1";
}
