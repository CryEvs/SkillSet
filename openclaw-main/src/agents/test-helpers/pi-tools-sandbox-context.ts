...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "skillset-sbx-test",
    runtimeLabel: params.containerName ?? "skillset-sbx-test",
    containerName: params.containerName ?? "skillset-sbx-test",
