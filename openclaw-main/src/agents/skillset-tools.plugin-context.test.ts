...
import { resolveSkillSetPluginToolInputs } from "./skillset-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

describe("skillset plugin tool context", () => {
  it("forwards trusted requester sender identity", () => {
    const result = resolveSkillSetPluginToolInputs({
      options: {
        config: {} as never,
