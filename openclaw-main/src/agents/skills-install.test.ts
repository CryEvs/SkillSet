...
import { resolveSkillSetMetadata, resolveSkillInvocationPolicy } from "./skills/frontmatter.js";
...
metadata: {"skillset":{"install":[{"id":"deps","kind":"node","package":"example-package"}]}}
---
...
const workspaceSuite = createFixtureSuite("skillset-skills-install-");
