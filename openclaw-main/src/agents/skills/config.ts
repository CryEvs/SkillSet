...
export function isConfigPathTruthy(config: SkillSetConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["skillset-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: SkillSetConfig): string[] | undefined {
