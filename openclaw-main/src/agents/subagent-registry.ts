...
type SubagentRegistryDeps = {
  ...
  resolveContextEngine?: (cfg: SkillSetConfig) => Promise<ContextEngine>;
};
...
async function resolveSubagentRegistryContextEngine(cfg: SkillSetConfig) {
...
function resolveSubagentWaitTimeoutMs(cfg: SkillSetConfig, runTimeoutSeconds?: number) {
