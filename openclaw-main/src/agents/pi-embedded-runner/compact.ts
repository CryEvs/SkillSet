...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureSkillSetModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createSkillSetCodingTools({
      exec: {
    ...
    const filteredBundledTools = applyFinalEffectiveToolPolicy({
      ...
      // createSkillSetCodingTools(...) also omit it, so both paths resolve
    ...
    try {
      ...
      // exact SkillSet-managed registrations so custom tools survive startup.
