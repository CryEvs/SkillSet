...
const formatDoctorNonInteractiveHintMock = vi.fn(() => "Run: skillset doctor --non-interactive");
...
describe("gateway tool restart continuation", () => {
  beforeEach(() => {
    ...
    formatDoctorNonInteractiveHintMock.mockReturnValue("Run: skillset doctor --non-interactive");
