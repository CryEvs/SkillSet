...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/skillset-sandbox",
    agentWorkspaceDir: "/tmp/skillset-workspace",
    workspaceAccess: "none",
    runtimeId: "skillset-sbx-test",
    runtimeLabel: "skillset-sbx-test",
    containerName: "skillset-sbx-test",
    ...
    browser: {
      ...
      containerName: "skillset-sbx-browser-test",
    },
