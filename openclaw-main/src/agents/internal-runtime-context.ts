export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_SKILLSET_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_SKILLSET_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[SKILLSET_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[SKILLSET_INTERNAL_CONTEXT_END]]";
