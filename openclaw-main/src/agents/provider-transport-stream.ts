...
const SIMPLE_TRANSPORT_API_ALIAS: Record<string, Api> = {
  "openai-responses": "skillset-openai-responses-transport",
  "openai-codex-responses": "skillset-openai-responses-transport",
  "openai-completions": "skillset-openai-completions-transport",
  "azure-openai-responses": "skillset-azure-openai-responses-transport",
  "anthropic-messages": "skillset-anthropic-messages-transport",
  "google-generative-ai": "skillset-google-generative-ai-transport",
};
