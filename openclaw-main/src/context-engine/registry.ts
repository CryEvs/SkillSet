...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("skillset.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("skillset.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: SkillSetConfig): Promise<ContextEngine> {
