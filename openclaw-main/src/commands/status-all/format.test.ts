...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://skillset.local")).toBe("https://skillset.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://skillset.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: skillset security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://skillset.local" },
      ...
      { Item: "Security", Value: "Run: skillset security audit --deep" },
