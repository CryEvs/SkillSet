...
export function collectMissingDefaultAccountBindingWarnings(cfg: SkillSetConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: SkillSetConfig): string[] {
  const warnings: string[] = [];
