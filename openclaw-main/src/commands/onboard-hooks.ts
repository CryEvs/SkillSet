...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.skillset.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("skillset hooks list")}`,
      `  ${formatCliCommand("skillset hooks enable <name>")}`,
      `  ${formatCliCommand("skillset hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
