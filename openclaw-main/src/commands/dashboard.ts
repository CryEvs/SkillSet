...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set SKILLSET_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `skillset dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control SkillSet.");
  } else if (hint) {
    runtime.log(hint);
  }
}
