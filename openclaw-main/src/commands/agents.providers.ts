...
function resolveDefaultAccountId(cfg: SkillSetConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SkillSetConfig): boolean {
...
export function summarizeBindings(cfg: SkillSetConfig, bindings: AgentBinding[]): string[] {
