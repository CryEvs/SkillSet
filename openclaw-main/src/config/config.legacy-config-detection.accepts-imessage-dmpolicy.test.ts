...
function expectSkillSetSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = SkillSetSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectSkillSetSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = SkillSetSchema.safeParse(config);
