...
export function applyMessageDefaults(cfg: SkillSetConfig): SkillSetConfig {
...
export function applyTalkConfigNormalization(config: SkillSetConfig): SkillSetConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: SkillSetConfig): SkillSetConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: SkillSetConfig): SkillSetConfig {
...
export function applyLoggingDefaults(cfg: SkillSetConfig): SkillSetConfig {
...
function hasAnthropicDefaultSignal(cfg: SkillSetConfig, env: NodeJS.ProcessEnv): boolean {
...
export function applyContextPruningDefaults(cfg: SkillSetConfig): SkillSetConfig {
...
export function applyCompactionDefaults(cfg: SkillSetConfig): SkillSetConfig {
