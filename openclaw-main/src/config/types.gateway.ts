...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "skillset.internal"). */
  domain?: string;
};
...
export type CanvasHostConfig = {
  enabled?: boolean;
  /** Directory to serve (default: ~/.skillset/workspace/canvas). */
  root?: string;
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/skillset"). */
  basePath?: string;
   ...
   * Default off; prefer hosted /__skillset__/canvas or /__skillset__/a2ui content.
   */
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/skillset/skillset/issues/47711
   */
