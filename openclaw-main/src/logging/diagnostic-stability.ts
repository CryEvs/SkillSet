...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __skillsetDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore.__skillsetDiagnosticStabilityState ??= createState();
  return globalStore.__skillsetDiagnosticStabilityState;
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore.__skillsetDiagnosticStabilityState = next;
}
