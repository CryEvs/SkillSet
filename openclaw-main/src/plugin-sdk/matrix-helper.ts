...
type FacadeModule = {
  ...
  requiresExplicitMatrixDefaultAccount: (cfg: SkillSetConfig, env?: NodeJS.ProcessEnv) => boolean;
  resolveConfiguredMatrixAccountIds: (cfg: SkillSetConfig, env?: NodeJS.ProcessEnv) => string[];
  ...
  resolveMatrixChannelConfig: (cfg: SkillSetConfig) => Record<string, unknown> | null;
  ...
  resolveMatrixDefaultOrOnlyAccountId: (cfg: SkillSetConfig, env?: NodeJS.ProcessEnv) => string;
