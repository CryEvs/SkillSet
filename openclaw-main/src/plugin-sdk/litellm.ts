...
import type { ModelDefinitionConfig, SkillSetConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: SkillSetConfig) => SkillSetConfig;
  applyLitellmProviderConfig: (cfg: SkillSetConfig) => SkillSetConfig;
