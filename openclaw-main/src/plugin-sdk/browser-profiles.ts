...
import type { BrowserConfig, BrowserProfileConfig, SkillSetConfig } from "../config/config.js";
import type { SsrFPolicy } from "../infra/net/ssrf.js";
import { resolvePreferredSkillSetTmpDir } from "../infra/tmp-skillset-dir.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

export const DEFAULT_SKILLSET_BROWSER_ENABLED = true;
export const DEFAULT_BROWSER_EVALUATE_ENABLED = true;
export const DEFAULT_SKILLSET_BROWSER_COLOR = "#FF4500";
export const DEFAULT_SKILLSET_BROWSER_PROFILE_NAME = "skillset";
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "skillset";
export const DEFAULT_AI_SNAPSHOT_MAX_CHARS = 80_000;
export const DEFAULT_UPLOAD_DIR = path.join(resolvePreferredSkillSetTmpDir(), "uploads");
