...
import type { SkillSetPluginApi } from "../plugins/types.js";
...
export type { SkillSetPluginToolContext, SkillSetPluginToolFactory } from "../plugins/types.js";
export type {
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: SkillSetConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
