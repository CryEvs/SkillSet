...
import type { AnyAgentTool, SkillSetPluginApi, PluginCommandContext } from "../plugins/types.js";
import { normalizeLowercaseStringOrEmpty } from "../shared/string-coerce.js";

export type { AnyAgentTool, SkillSetPluginApi, PluginCommandContext };
...
type DefineBundledChannelEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  registerCliMetadata?: (api: SkillSetPluginApi) => void;
  registerFull?: (api: SkillSetPluginApi) => void;
};
...
const disableBundledEntrySourceFallbackEnv = "SKILLSET_DISABLE_BUNDLED_ENTRY_SOURCE_FALLBACK";
