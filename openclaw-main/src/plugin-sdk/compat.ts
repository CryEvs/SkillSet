...
const shouldWarnCompatImport =
  ...
  process.env.SKILLSET_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "skillset/plugin-sdk/compat is deprecated for new plugins. Migrate to focused skillset/plugin-sdk/<subpath> imports. See https://docs.skillset.ai/plugins/sdk-migration",
    {
      code: "SKILLSET_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.skillset.ai/plugins/sdk-migration",
    },
  );
}
