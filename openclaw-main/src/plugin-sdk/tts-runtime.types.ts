...
export type TtsRuntimeFacade = {
  _test: TtsTestFacade;
  buildTtsSystemPromptHint: (cfg: SkillSetConfig) => string | undefined;
  ...
  resolveTtsConfig: (cfg: SkillSetConfig) => ResolvedTtsConfig;
  resolveTtsPrefsPath: (config: ResolvedTtsConfig) => string;
  resolveTtsProviderOrder: (primary: TtsProvider, cfg?: SkillSetConfig) => TtsProvider[];
