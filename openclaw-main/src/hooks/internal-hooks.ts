/**
 * Hook system for SkillSet agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("skillset.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("skillset.internalHooksEnabled");
