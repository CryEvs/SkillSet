...
const resolveGatewayLogPathsMock = vi.fn(() => ({
  logDir: "C:\\tmp\\skillset-state\\logs",
  stdoutPath: "C:\\tmp\\skillset-state\\logs\\gateway.log",
  stderrPath: "C:\\tmp\\skillset-state\\logs\\gateway.err.log",
}));
const resolveGatewayRestartLogPathMock = vi.fn(
  () => "C:\\tmp\\skillset-state\\logs\\gateway-restart.log",
);
