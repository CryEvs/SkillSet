...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: SkillSetConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: SkillSetConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: SkillSetConfig;
  agentDir?: string;
  listProviders: (cfg?: SkillSetConfig) => CapabilityProviderCandidate[];
}): string[] {
