...
function collectCandidateAgentDirs(
  ...
  dirs.add(resolveUserPath(resolveSkillSetAgentDir(env), env));
...
function hasConfiguredPluginEntries(config: SkillSetConfig): boolean {
...
function hasRuntimeWebToolConfigSurface(config: SkillSetConfig): boolean {
