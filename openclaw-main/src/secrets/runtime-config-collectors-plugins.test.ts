...
function makeContext(sourceConfig: SkillSetConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: SkillSetConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: SkillSetConfig): void {
