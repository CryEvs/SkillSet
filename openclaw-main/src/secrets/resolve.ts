...
function resolveResolutionLimits(config: SkillSetConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: SkillSetConfig): SecretProviderConfig {
