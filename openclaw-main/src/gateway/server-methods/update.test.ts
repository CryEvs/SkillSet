...
vi.mock("../../infra/skillset-root.js", async () => {
  const actual = await vi.importActual<typeof import("../../infra/skillset-root.js")>(
    "../../infra/skillset-root.js",
  );
  return {
    ...actual,
    resolveSkillSetPackageRoot: async () => "/tmp/skillset",
  };
});
