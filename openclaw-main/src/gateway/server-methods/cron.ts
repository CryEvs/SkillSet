...
function listConfiguredAnnounceChannelIds(cfg: SkillSetConfig): string[] {
...
function assertValidCronAnnounceDelivery(params: { cfg: SkillSetConfig; delivery?: CronDelivery }) {
...
function assertValidCronCreateDelivery(cfg: SkillSetConfig, jobCreate: CronJobCreate) {
