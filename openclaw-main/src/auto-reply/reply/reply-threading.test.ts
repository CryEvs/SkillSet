...
const emptyCfg = {} as SkillSetConfig;
...
describe("resolveReplyToMode", () => {
  ...
  it("uses registered channel threading adapters for runtime reply-mode resolution", () => {
    ...
    expect(resolveReplyToMode({} as SkillSetConfig, "whatsapp", "work", "group")).toBe("first");
    expect(resolveReplyToMode({} as SkillSetConfig, "whatsapp", "default", "group")).toBe("all");
  });
});
