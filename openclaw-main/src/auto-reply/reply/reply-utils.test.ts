...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bskillset\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: {
          identityName: "SkillSet",
          provider: "anthropic",
          model: "claude-opus-4-6",
          thinkingLevel: "high",
        },
        expected: "[SkillSet] anthropic/claude-opus-4-6 (think:high)",
      },
    ] as const;
