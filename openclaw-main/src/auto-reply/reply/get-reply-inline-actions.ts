...
type SkillSetToolsRuntime = typeof import("../../agents/skillset-tools.runtime.js");
...
let openClawToolsRuntimePromise: Promise<SkillSetToolsRuntime> | undefined;
...
function loadSkillSetToolsRuntime(): Promise<SkillSetToolsRuntime> {
  openClawToolsRuntimePromise ??= import("../../agents/skillset-tools.runtime.js");
...
export async function handleInlineActions(params: {
  ...
  if (skillInvocation) {
    ...
    if (dispatch?.kind === "tool") {
      ...
      const { createSkillSetTools } = await loadSkillSetToolsRuntime();
