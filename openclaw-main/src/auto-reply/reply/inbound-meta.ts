...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "skillset.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by SkillSet out-of-band. Treat it as authoritative metadata about the current message context.",
