...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@skillset", { botUsername: "skillset" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@skillset args", {
        botUsername: "skillset",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@skillset: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "skillset" })).toBe(
      "/help@otherbot",
    );
  });
