...
export const A2UI_PATH = "/__skillset__/a2ui";

export const CANVAS_HOST_PATH = "/__skillset__/canvas";

export const CANVAS_WS_PATH = "/__skillset__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.skillsetCanvasA2UIAction.postMessage(...)
  // - Android: window.skillsetCanvasA2UIAction.postMessage(...)
  const handlerNames = ["skillsetCanvasA2UIAction"];
  ...
  globalThis.SkillSet = globalThis.SkillSet ?? {};
  globalThis.SkillSet.postMessage = postToNode;
  globalThis.SkillSet.sendUserAction = sendUserAction;
  globalThis.skillsetPostMessage = postToNode;
  globalThis.skillsetSendUserAction = sendUserAction;
