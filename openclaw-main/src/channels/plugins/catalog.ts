...
import type { SkillSetPackageManifest } from "../../plugins/manifest.js";
...
const ENV_CATALOG_PATHS = ["SKILLSET_PLUGIN_CATALOG_PATHS", "SKILLSET_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<SkillSetPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
