...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: SkillSetConfig): string | undefined {
  ...
  function listAccountIds(cfg: SkillSetConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: SkillSetConfig): string {
