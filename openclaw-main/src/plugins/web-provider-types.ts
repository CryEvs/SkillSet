...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: SkillSetConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: SkillSetConfig, value: unknown) => void;
  applySelectionConfig?: (config: SkillSetConfig) => SkillSetConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => SkillSetConfig | Promise<SkillSetConfig>;
