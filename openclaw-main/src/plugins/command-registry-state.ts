...
import type { SkillSetPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = SkillSetPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("skillset.pluginCommandsState");
