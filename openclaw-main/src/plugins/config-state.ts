...
} & PluginActivationConfigSourceLike<SkillSetConfig>;
...
const hasExplicitMemorySlot = (plugins?: SkillSetConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: SkillSetConfig["plugins"]) =>
  Boolean(
    plugins?.entries &&
    Object.prototype.hasOwnProperty.call(plugins.entries, defaultSlotIdForKey("memory")),
  );

export const hasExplicitPluginConfig = (plugins?: SkillSetConfig["plugins"]) =>
