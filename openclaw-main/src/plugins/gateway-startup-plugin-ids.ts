...
function resolveGatewayStartupDreamingPluginIds(config: SkillSetConfig): Set<string> {
...
function resolveExplicitMemorySlotStartupPluginId(config: SkillSetConfig): string | undefined {
