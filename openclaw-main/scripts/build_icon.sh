...
# Defaults target the SkillSet assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/SkillSet/Resources/SkillSet.icns"}
