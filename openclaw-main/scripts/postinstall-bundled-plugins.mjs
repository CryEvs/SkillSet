...
// legacy eager-install escape hatch is explicitly enabled; `skillset doctor
...
const DISABLE_POSTINSTALL_ENV = "SKILLSET_DISABLE_BUNDLED_PLUGIN_POSTINSTALL";
const EAGER_BUNDLED_PLUGIN_DEPS_ENV = "SKILLSET_EAGER_BUNDLED_PLUGIN_DEPS";
  ...
  const createTempPath =
    ...
    ((unsafeTargetPath) =>
      join(
        ...
        `.${basename(unsafeTargetPath)}.skillset-hotfix-${randomUUID()}`,
      ));
  const writeFile =
