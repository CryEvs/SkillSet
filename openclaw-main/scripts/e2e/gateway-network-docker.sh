...
IMAGE_NAME="$(docker_e2e_resolve_image "skillset-gateway-network-e2e" SKILLSET_GATEWAY_NETWORK_E2E_IMAGE)"
SKIP_BUILD="${SKILLSET_GATEWAY_NETWORK_E2E_SKIP_BUILD:-0}"

PORT="18789"
TOKEN="e2e-$(date +%s)-$$"
NET_NAME="skillset-net-e2e-$$"
GW_NAME="skillset-gateway-e2e-$$"
