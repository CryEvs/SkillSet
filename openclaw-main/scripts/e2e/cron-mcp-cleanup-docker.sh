...
IMAGE_NAME="$(docker_e2e_resolve_image "skillset-cron-mcp-cleanup-e2e" SKILLSET_IMAGE)"
PORT="18789"
TOKEN="cron-mcp-e2e-$(date +%s)-$$"
CONTAINER_NAME="skillset-cron-mcp-e2e-$$"
CLIENT_LOG="$(mktemp -t skillset-cron-mcp-client-log.XXXXXX)"
