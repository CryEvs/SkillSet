...
const targetModel =
  modelIds.find((id) => id === "skillset/default") ?? modelIds.find((id) => id === "skillset");
if (!targetModel) {
  throw new Error(`skillset model missing from Open WebUI model list: ${JSON.stringify(modelIds)}`);
}
