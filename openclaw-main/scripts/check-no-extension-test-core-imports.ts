...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']skillset\/plugin-sdk["']/,
    hint: "Use skillset/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']skillset\/plugin-sdk\/test-utils["']/,
    hint: "Use skillset/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']skillset\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/plugins/* for repo-only helpers, or skillset/plugin-sdk/testing for public surfaces.",
  },
  {
  ...
  },
  {
    ...
    hint: "Use skillset/plugin-sdk/testing for channel contract test helpers.",
  },
];
