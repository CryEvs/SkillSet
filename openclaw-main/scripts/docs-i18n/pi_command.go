...
const (
	envDocsPiExecutable     = "SKILLSET_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "SKILLSET_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "SKILLSET_DOCS_I18N_PI_PACKAGE_VERSION"
	envDocsPiOmitProvider   = "SKILLSET_DOCS_I18N_PI_OMIT_PROVIDER"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "skillset", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
