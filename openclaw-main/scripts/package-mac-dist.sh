...
# Output:
# - dist/SkillSet.app
# - dist/SkillSet-<version>.zip
# - dist/SkillSet-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.skillset.mac}"
...
APP="$ROOT_DIR/dist/SkillSet.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/SkillSet-$VERSION.zip"
DMG="$ROOT_DIR/dist/SkillSet-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/SkillSet-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/SkillSet-$VERSION.dSYM.zip"
