...
if [[ -z "$version_content" ]]; then
  echo "<h2>SkillSet $VERSION</h2>"
  echo "<p>Latest SkillSet update.</p>"
  echo "<p><a href=\"https://github.com/skillset/skillset/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
