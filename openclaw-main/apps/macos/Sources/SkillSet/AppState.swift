...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = SkillSetConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = SkillSetConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: SkillSetConfigFile.loadDict(),
            draft: .init(
        ...
        SkillSetConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/skillset"
        state.remoteCliPath = ""
        return state
    }
}
