...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.skillset", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other SkillSet windows, but below the system’s pop-up menus.
