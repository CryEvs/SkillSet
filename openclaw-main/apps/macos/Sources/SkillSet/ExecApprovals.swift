...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.skillset", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        SkillSetPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        SkillSetPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
