...
enum UIStrings {
    static let welcomeTitle = "Welcome to SkillSet"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "skillset.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: SkillSetChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g skillset@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: SkillSetChatViewModel(
