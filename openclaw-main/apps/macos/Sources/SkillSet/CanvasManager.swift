...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.skillset", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("SkillSet/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__skillset__/a2ui/").absoluteString + "?platform=macos"
    }
