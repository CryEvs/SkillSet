...
public typealias SkillSetPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias SkillSetPlatformImage = UIImage
#endif

public struct SkillSetChatUsageCost: Codable, Hashable, Sendable {
...
public struct SkillSetChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: SkillSetChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(SkillSetChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct SkillSetChatMessageContent: Codable, Hashable, Sendable {
...
public struct SkillSetChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [SkillSetChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: SkillSetChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [SkillSetChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: SkillSetChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(SkillSetChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([SkillSetChatMessageContent].self, forKey: .content) {
...
public struct SkillSetChatHistoryPayload: Codable, Sendable {
...
public struct SkillSetSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct SkillSetSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [SkillSetSessionPreviewItem]
}

public struct SkillSetSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [SkillSetSessionPreviewEntry]

    public init(ts: Int, previews: [SkillSetSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct SkillSetChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct SkillSetChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct SkillSetAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct SkillSetChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct SkillSetGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct SkillSetPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: SkillSetPlatformImage?
...
public struct SkillSetChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
