...
@MainActor
public struct SkillSetChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: SkillSetChatViewModel
    ...
    public init(
        viewModel: SkillSetChatViewModel,
    ...
    private var visibleMessages: [SkillSetChatMessage] {
        let base: [SkillSetChatMessage]
    ...
    private func mergeToolResults(in messages: [SkillSetChatMessage]) -> [SkillSetChatMessage] {
        ...
        for message in messages {
            ...
            let merged = SkillSetChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: SkillSetChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func shouldDisplayMessage(_ message: SkillSetChatMessage) -> Bool {
    ...
    private func primaryText(in message: SkillSetChatMessage) -> String {
    ...
    private func hasInlineAttachments(in message: SkillSetChatMessage) -> Bool {
    ...
    private func toolCalls(in message: SkillSetChatMessage) -> [SkillSetChatMessageContent] {
    ...
    private func inlineToolResults(in message: SkillSetChatMessage) -> [SkillSetChatMessageContent] {
        message.content.filter { content in
            let kind = (content.type ?? "").lowercased()
    ...
    private func toolCallIds(in message: SkillSetChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: SkillSetChatMessage) -> String {
    ...
    var body: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 18, style: .continuous)
                .fill(SkillSetChatTheme.subtleCard)
                .overlay(
                    RoundedRectangle(cornerRadius: 18, style: .continuous)
