...
public enum SkillSetTalkCommand: String, Codable, Sendable {
...
public struct SkillSetTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct SkillSetTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
