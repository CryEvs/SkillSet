...
public enum SkillSetCanvasA2UICommand: String, Codable, Sendable {
...
public struct SkillSetCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SkillSetCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
