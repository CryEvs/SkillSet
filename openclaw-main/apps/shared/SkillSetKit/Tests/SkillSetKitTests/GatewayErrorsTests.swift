...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "skillset devices approve req-123",
            docsURLString: "https://docs.skillset.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "skillset devices approve req-123")
        #expect(error.docsURLString == "https://docs.skillset.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "skillset devices approve req-123")
    }
