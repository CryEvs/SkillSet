...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: SkillSetPhotosLatestParams) async throws -> SkillSetPhotosLatestPayload {
        ...
        var results: [SkillSetPhotoPayload] = []
        ...
        return SkillSetPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> SkillSetPhotoPayload
    {
