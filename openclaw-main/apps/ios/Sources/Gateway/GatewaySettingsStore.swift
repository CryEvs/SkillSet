...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.skillset.gateway"
    private static let nodeService = "ai.skillset.node"
    private static let talkService = "ai.skillset.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.skillset.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.skillset.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("skillset-gateway.log")
    }
