...
final class GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [SkillSetCapability.canvas.rawValue, SkillSetCapability.screen.rawValue]
        ...
        if cameraEnabled { caps.append(SkillSetCapability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(SkillSetCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = SkillSetLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(SkillSetCapability.location.rawValue) }

        caps.append(SkillSetCapability.device.rawValue)
        if WatchMessagingService.isSupportedOnDevice() {
            caps.append(SkillSetCapability.watch.rawValue)
        }
        caps.append(SkillSetCapability.photos.rawValue)
        caps.append(SkillSetCapability.contacts.rawValue)
        caps.append(SkillSetCapability.calendar.rawValue)
        caps.append(SkillSetCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(SkillSetCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            SkillSetScreenCommand.record.rawValue,
            SkillSetSystemCommand.notify.rawValue,
            SkillSetChatCommand.push.rawValue,
        ...
        if caps.contains(SkillSetCapability.camera.rawValue) {
            commands.append(SkillSetCameraCommand.list.rawValue)
            commands.append(SkillSetCameraCommand.snap.rawValue)
            commands.append(SkillSetCameraCommand.clip.rawValue)
        }
        if caps.contains(SkillSetCapability.location.rawValue) {
            commands.append(SkillSetLocationCommand.get.rawValue)
        }
        if caps.contains(SkillSetCapability.device.rawValue) {
            commands.append(SkillSetDeviceCommand.status.rawValue)
            commands.append(SkillSetDeviceCommand.info.rawValue)
        }
        if caps.contains(SkillSetCapability.watch.rawValue) {
            commands.append(SkillSetWatchCommand.status.rawValue)
            commands.append(SkillSetWatchCommand.notify.rawValue)
        }
        if caps.contains(SkillSetCapability.photos.rawValue) {
            commands.append(SkillSetPhotosCommand.latest.rawValue)
        }
        if caps.contains(SkillSetCapability.contacts.rawValue) {
            commands.append(SkillSetContactsCommand.search.rawValue)
            commands.append(SkillSetContactsCommand.add.rawValue)
        }
        if caps.contains(SkillSetCapability.calendar.rawValue) {
            commands.append(SkillSetCalendarCommand.events.rawValue)
            commands.append(SkillSetCalendarCommand.add.rawValue)
        }
        if caps.contains(SkillSetCapability.reminders.rawValue) {
            commands.append(SkillSetRemindersCommand.list.rawValue)
            commands.append(SkillSetRemindersCommand.add.rawValue)
        }
        if caps.contains(SkillSetCapability.motion.rawValue) {
            commands.append(SkillSetMotionCommand.activity.rawValue)
            commands.append(SkillSetMotionCommand.pedometer.rawValue)
        }
