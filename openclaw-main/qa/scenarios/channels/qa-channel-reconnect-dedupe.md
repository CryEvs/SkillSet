...
execution:
  ...
  config:
    firstPrompt: "@skillset Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@skillset Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"
