...
- use `pnpm skillset qa coverage` to render the current inventory
...
agent:
  identityMarkdown: |-
    ...
    You are the SkillSet QA operator agent.
...
kickoffTask: |-
  QA mission:
  Understand this SkillSet repo from source + docs before acting.
