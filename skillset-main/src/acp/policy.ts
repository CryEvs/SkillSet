...
export function isAcpEnabledByPolicy(cfg: SkillSetConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: SkillSetConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: SkillSetConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: SkillSetConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: SkillSetConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: SkillSetConfig, agentId: string): boolean {
