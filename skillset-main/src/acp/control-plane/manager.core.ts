...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: SkillSetConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: SkillSetConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: SkillSetConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: SkillSetConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: SkillSetConfig }): Promise<void> {
