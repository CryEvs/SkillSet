...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "skillset-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "skillset-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "skillset-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "skillset-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "skillset-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "skillset-legacy-state");
    const configDir = path.join("/tmp", "skillset-current-config");
