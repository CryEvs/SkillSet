...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: SkillSetConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: SkillSetConfig }>(
  collector: WarningCollector<{ cfg: SkillSetConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: SkillSetConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: SkillSetConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: SkillSetConfig },
>(
  projectCfg: (cfg: SkillSetConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: SkillSetConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: SkillSetConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: SkillSetConfig },
>(params: {
  providerConfigPresent: (cfg: SkillSetConfig) => boolean;
