...
export function listChannelMessageActions(cfg: SkillSetConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: SkillSetConfig): ChannelMessageCapability[] {
