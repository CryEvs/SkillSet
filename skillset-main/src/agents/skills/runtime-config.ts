...
function hasConfiguredSkillApiKeyRef(config?: SkillSetConfig): boolean {
...
export function resolveSkillRuntimeConfig(config?: SkillSetConfig): SkillSetConfig | undefined {
