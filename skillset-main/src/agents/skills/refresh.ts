...
function resolveWatchPaths(workspaceDir: string, config?: SkillSetConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: SkillSetConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: SkillSetConfig }) {
