...
type ModelsConfig = NonNullable<SkillSetConfig["models"]>;
...
export async function planSkillSetModelsJsonWithDeps(
  params: {
    cfg: SkillSetConfig;
...
export async function planSkillSetModelsJson(
  params: Parameters<typeof planSkillSetModelsJsonWithDeps>[0],
): Promise<ModelsJsonPlan> {
  return planSkillSetModelsJsonWithDeps(params);
}
