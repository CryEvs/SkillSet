...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<SkillSetConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<SkillSetConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: SkillSetConfig): WebSearchConfig {
