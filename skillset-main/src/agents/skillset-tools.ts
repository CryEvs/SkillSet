...
import { resolveSkillSetPluginToolsForOptions } from "./skillset-plugin-tools.js";
import { applyNodesToolWorkspaceGuard } from "./skillset-tools.nodes-workspace-guard.js";
import {
  collectPresentSkillSetTools,
  isUpdatePlanToolEnabledForSkillSetTools,
} from "./skillset-tools.registration.js";
...
type SkillSetToolsDeps = {
  callGateway: typeof callGateway;
  config?: SkillSetConfig;
};

const defaultSkillSetToolsDeps: SkillSetToolsDeps = {
  callGateway,
};

let openClawToolsDeps: SkillSetToolsDeps = defaultSkillSetToolsDeps;

export function createSkillSetTools(
  options?: {
  ...
  const tools: AnyAgentTool[] = [
    ...
    ...collectPresentSkillSetTools([imageGenerateTool, musicGenerateTool, videoGenerateTool]),
    ...(embedded
      ? []
      : [
          createGatewayTool({
    ...
    ...collectPresentSkillSetTools([webSearchTool, webFetchTool, imageTool, pdfTool]),
  ];
  ...
  const wrappedPluginTools = resolveSkillSetPluginToolsForOptions({
    options,
    resolvedConfig,
...
export const __testing = {
  setDepsForTest(overrides?: Partial<SkillSetToolsDeps>) {
    openClawToolsDeps = overrides
      ? {
          ...defaultSkillSetToolsDeps,
          ...overrides,
        }
      : defaultSkillSetToolsDeps;
  },
