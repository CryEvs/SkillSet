...
export const DEFAULT_SANDBOX_IMAGE = "skillset-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "skillset-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "skillset-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "skillset-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-04-05-cdp-source-range";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "skillset-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "skillset-sandbox-browser";
