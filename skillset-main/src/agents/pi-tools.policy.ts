...
export function resolveSubagentToolPolicy(cfg?: SkillSetConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: SkillSetConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: SkillSetConfig["tools"];
