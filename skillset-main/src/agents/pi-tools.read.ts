...
function resolveAdaptiveReadMaxBytes(options?: SkillSetReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createSkillSetReadTool(base, {
...
export function createSkillSetReadTool(
  base: AnyAgentTool,
  options?: SkillSetReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
