...
async function resolveContext(config: SkillSetConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): SkillSetConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
