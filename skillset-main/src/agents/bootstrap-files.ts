...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "skillset:bootstrap-context:full";
...
export function resolveContextInjectionMode(config?: SkillSetConfig): AgentContextInjection {
