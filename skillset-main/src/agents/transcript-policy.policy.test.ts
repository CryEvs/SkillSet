...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.SKILLSET_BUNDLED_PLUGINS_DIR;
  delete env.SKILLSET_SKIP_PROVIDERS;
  delete env.SKILLSET_SKIP_CHANNELS;
  delete env.SKILLSET_SKIP_CRON;
  delete env.SKILLSET_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,
