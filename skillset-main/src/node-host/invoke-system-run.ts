...
type ExecToolConfig = NonNullable<NonNullable<SkillSetConfig["tools"]>["exec"]>;
...
async function loadSystemRunConfig(opts: HandleSystemRunInvokeOptions): Promise<SkillSetConfig> {
  if (opts.loadConfig) {
