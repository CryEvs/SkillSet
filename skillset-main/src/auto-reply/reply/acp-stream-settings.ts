...
function resolveAcpStreamCoalesceIdleMs(cfg: SkillSetConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: SkillSetConfig): number {
...
export function resolveAcpProjectionSettings(cfg: SkillSetConfig): AcpProjectionSettings {
