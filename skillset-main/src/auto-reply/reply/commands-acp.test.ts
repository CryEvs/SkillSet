...
vi.mock("../../agents/acp-spawn.js", () => ({
  resolveAcpSpawnRuntimePolicyError: (params: { cfg?: SkillSetConfig }) =>
...
function createDiscordParams(commandBody: string, cfg: SkillSetConfig = baseCfg) {
...
function createThreadParams(commandBody: string, cfg: SkillSetConfig = baseCfg) {
...
async function runDiscordAcpCommand(commandBody: string, cfg: SkillSetConfig = baseCfg) {
  return handleAcpCommand(createDiscordParams(commandBody, cfg), true);
}

async function runThreadAcpCommand(commandBody: string, cfg: SkillSetConfig = baseCfg) {
  return handleAcpCommand(createThreadParams(commandBody, cfg), true);
}

async function runTelegramAcpCommand(commandBody: string, cfg: SkillSetConfig = baseCfg) {
...
async function runTelegramDmAcpCommand(commandBody: string, cfg: SkillSetConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runSlackDmAcpCommand(commandBody: string, cfg: SkillSetConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
function createMatrixThreadParams(commandBody: string, cfg: SkillSetConfig = baseCfg) {
...
async function runMatrixAcpCommand(commandBody: string, cfg: SkillSetConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runMatrixThreadAcpCommand(commandBody: string, cfg: SkillSetConfig = baseCfg) {
  return handleAcpCommand(createMatrixThreadParams(commandBody, cfg), true);
}

async function runFeishuDmAcpCommand(commandBody: string, cfg: SkillSetConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runLineDmAcpCommand(commandBody: string, cfg: SkillSetConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runBlueBubblesDmAcpCommand(commandBody: string, cfg: SkillSetConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runIMessageDmAcpCommand(commandBody: string, cfg: SkillSetConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
  ...
  it("sanitizes leaked task and runtime details in ACP status output", async () => {
    ...
    hoisted.readAcpSessionEntryMock.mockReturnValue({
      ...
      acp: {
        ...
        lastError: [
          "SkillSet runtime context (internal):",
    ...
    expect(result?.reply?.text).not.toContain("SkillSet runtime context (internal):");
