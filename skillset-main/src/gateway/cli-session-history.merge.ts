...
function resolveImportedExternalId(message: unknown): string | undefined {
  ...
  const meta =
    "__skillset" in message &&
    (message as { __skillset?: unknown }).__skillset &&
    typeof (message as { __skillset?: unknown }).__skillset === "object"
      ? ((message as { __skillset?: Record<string, unknown> }).__skillset ?? {})
      : undefined;
