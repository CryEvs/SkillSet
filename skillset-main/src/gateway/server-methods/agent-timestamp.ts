 ...
 *
 * @see https://github.com/skillset/skillset/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an SkillSetConfig.
 */
export function timestampOptsFromConfig(cfg: SkillSetConfig): TimestampInjectionOptions {
  return {
