...
import type { ConfigValidationIssue, SkillSetConfig } from "../../config/types.skillset.js";
...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: SkillSetConfig; schema: ConfigSchemaResponse } | null {
...
function didSharedGatewayAuthChange(prev: SkillSetConfig, next: SkillSetConfig): boolean {
...
function loadSchemaWithPlugins(): ConfigSchemaResponse {
  ...
  // our cache. However, loadConfig() and loadSkillSetPlugins() (called inside
