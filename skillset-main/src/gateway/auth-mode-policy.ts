...
export function hasAmbiguousGatewayAuthModeConfig(cfg: SkillSetConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: SkillSetConfig): void {
