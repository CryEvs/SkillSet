...
export function collectConfiguredModelPricingRefs(config: SkillSetConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: SkillSetConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
