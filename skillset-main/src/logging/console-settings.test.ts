...
let originalSkillSetTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalSkillSetTestConsole = process.env.SKILLSET_TEST_CONSOLE;
  process.env.SKILLSET_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalSkillSetTestConsole === undefined) {
    delete process.env.SKILLSET_TEST_CONSOLE;
  } else {
    process.env.SKILLSET_TEST_CONSOLE = originalSkillSetTestConsole;
  }
