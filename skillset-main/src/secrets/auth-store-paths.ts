...
export function listAuthProfileStorePaths(config: SkillSetConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: SkillSetConfig, stateDir: string): string[] {
