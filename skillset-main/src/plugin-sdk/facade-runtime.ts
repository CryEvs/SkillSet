...
const SKILLSET_SOURCE_EXTENSIONS_ROOT = path.resolve(SKILLSET_PACKAGE_ROOT, "extensions");
...
function resolveFacadeModuleLocationUncached(params: {
  ...
  const bundledLocation = resolveBundledFacadeModuleLocation({
    ...
    packageRoot: SKILLSET_PACKAGE_ROOT,
    bundledPluginsDir,
  });
  if (bundledLocation) {
...
function buildFacadeActivationCheckParams(
  ...
  return {
    ...params,
    location,
    sourceExtensionsRoot: SKILLSET_SOURCE_EXTENSIONS_ROOT,
    resolutionKey: createFacadeResolutionKey(params),
  };
}
