...
import type { ModelProviderConfig, SkillSetConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyOpenrouterConfig: (cfg: SkillSetConfig) => SkillSetConfig;
  applyOpenrouterProviderConfig: (cfg: SkillSetConfig) => SkillSetConfig;
