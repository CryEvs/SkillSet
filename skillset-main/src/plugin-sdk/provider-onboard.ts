...
export type { SkillSetConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: SkillSetConfig, ...args: TArgs) => SkillSetConfig;
  applyConfig: (cfg: SkillSetConfig, ...args: TArgs) => SkillSetConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: SkillSetConfig, preset: TParams) => SkillSetConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: SkillSetConfig): {
  next: SkillSetConfig;
  changed: boolean;
} {
