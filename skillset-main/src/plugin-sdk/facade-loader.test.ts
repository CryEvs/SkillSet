...
const FACADE_LOADER_GLOBAL = "__skillsetTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors bundled plugin dir overrides outside the package root", () => {
    const overrideA = createBundledPluginDir("skillset-facade-loader-a-", "override-a");
    const overrideB = createBundledPluginDir("skillset-facade-loader-b-", "override-b");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const dir = createBundledPluginDir("skillset-facade-loader-ids-", "identity-check");
  ...
  it("keeps Windows dist facade loads off Jiti native import", () => {
    const dir = createTempDirSync("skillset-facade-loader-windows-dist-");
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const dir = createCircularPluginDir("skillset-facade-loader-circular-");
    process.env.SKILLSET_BUNDLED_PLUGINS_DIR = dir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const dir = createThrowingPluginDir("skillset-facade-loader-throw-");
    process.env.SKILLSET_BUNDLED_PLUGINS_DIR = dir;
