...
type ChannelConfigAccessorParams<Config extends SkillSetConfig = SkillSetConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends SkillSetConfig = SkillSetConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends SkillSetConfig = SkillSetConfig>(
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: SkillSetConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends SkillSetConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends SkillSetConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends SkillSetConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
