...
import type { SkillSetPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: SkillSetPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): SkillSetPluginConfigSchema {
  return {
