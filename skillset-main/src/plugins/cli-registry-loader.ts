...
export type PluginCliCommandGroupEntry = {
  pluginId: string;
  placeholders: readonly SkillSetPluginCliCommandDescriptor[];
  names: readonly string[];
  register: (program: SkillSetPluginCliContext["program"]) => Promise<void>;
};
...
export async function loadPluginCliMetadataRegistryWithContext(
  ...
  return {
    ...context,
    registry: await loadSkillSetPluginCliRegistry(
