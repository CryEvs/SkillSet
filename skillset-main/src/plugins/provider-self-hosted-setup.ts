...
export function applyProviderDefaultModel(cfg: SkillSetConfig, modelRef: string): SkillSetConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: SkillSetConfig; modelId: string; modelRef: string; profileId: string } {
