...
import { normalizeSkillSetVersionBase } from "../config/version.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeSkillSetVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeSkillSetVersionBase(plugin.version) ??
    plugin.version
  );
}
