...
const resolveAuthAgentDir = (agentDir?: string) => agentDir ?? resolveSkillSetAgentDir();
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: SkillSetConfig): SecretRef {
