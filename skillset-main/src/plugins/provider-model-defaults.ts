...
export function applyGoogleGeminiModelDefault(cfg: SkillSetConfig): {
  next: SkillSetConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: SkillSetConfig): SkillSetConfig {
...
export function applyOpenAIConfig(cfg: SkillSetConfig): SkillSetConfig {
...
export function applyOpencodeGoModelDefault(cfg: SkillSetConfig): {
  next: SkillSetConfig;
  changed: boolean;
} {
