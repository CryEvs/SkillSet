...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("SKILLSET_GATEWAY_TOKEN", "");
    vi.stubEnv("SKILLSET_GATEWAY_PASSWORD", "");
    vi.stubEnv("SKILLSET_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses SKILLSET_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          SKILLSET_GATEWAY_TOKEN: "new-token",
        },
