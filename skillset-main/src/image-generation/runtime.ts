...
function buildNoImageGenerationModelConfiguredMessage(cfg: SkillSetConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: SkillSetConfig }) {
