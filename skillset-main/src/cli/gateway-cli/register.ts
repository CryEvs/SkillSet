      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["skillset gateway run", "Run the gateway in the foreground."],
            ["skillset gateway status", "Show service status plus connectivity/capability."],
            ["skillset gateway discover", "Find local and wide-area gateway beacons."],
            ["skillset gateway stability", "Show recent stability diagnostics."],
            ["skillset gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.skillset.ai/cli/gateway")}\n`,
      ),
  );
