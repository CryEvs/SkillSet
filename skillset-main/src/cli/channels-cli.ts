    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["skillset channels list", "List configured channels and auth profiles."],
          ["skillset channels status --probe", "Run channel status checks and probes."],
          [
            "skillset channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["skillset channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.skillset.ai/cli/channels",
        )}\n`,
    );
