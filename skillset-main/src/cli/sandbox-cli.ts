...
const SANDBOX_EXAMPLES = {
  main: [
    ["skillset sandbox list", "List all sandbox containers."],
    ["skillset sandbox list --browser", "List only browser containers."],
    ["skillset sandbox recreate --all", "Recreate all containers."],
    ["skillset sandbox recreate --session main", "Recreate a specific session."],
    ["skillset sandbox recreate --agent mybot", "Recreate agent containers."],
    ["skillset sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["skillset sandbox list", "List all sandbox containers."],
    ["skillset sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["skillset sandbox recreate --all", "Recreate all containers."],
    ["skillset sandbox recreate --session main", "Recreate a specific session."],
    ["skillset sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["skillset sandbox recreate --browser --all", "Recreate only browser containers."],
    ["skillset sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["skillset sandbox explain", "Show effective sandbox config."],
    ["skillset sandbox explain --session agent:main:main", "Explain a specific session."],
    ["skillset sandbox explain --agent work", "Explain an agent sandbox."],
    ["skillset sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.skillset.ai/cli/sandbox")}\n`,
    )
    .action(() => {
