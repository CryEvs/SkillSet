...
import { serveSkillSetChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage SkillSet MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose SkillSet channels over MCP stdio")
