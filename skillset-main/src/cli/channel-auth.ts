...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: SkillSetConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: SkillSetConfig, mode: ChannelAuthMode): string {
