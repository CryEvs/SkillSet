    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["skillset directory self --channel slack", "Show the connected account identity."],
          [
            'skillset directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["skillset directory groups list --channel discord", "List available groups/channels."],
          [
            "skillset directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.skillset.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
