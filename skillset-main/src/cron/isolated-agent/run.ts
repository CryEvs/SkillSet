...
function hasConfiguredAuthProfiles(cfg: SkillSetConfig): boolean {
  return (
...
async function prepareCronRunContext(params: {
  ...
  const cfgWithAgentDefaults: SkillSetConfig = {
    ...input.cfg,
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.SKILLSET_TEST_FAST === "1";
