...
function buildNoVideoGenerationModelConfiguredMessage(cfg: SkillSetConfig): string {
...
export function listRuntimeVideoGenerationProviders(params?: { config?: SkillSetConfig }) {
