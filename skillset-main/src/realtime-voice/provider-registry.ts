...
function resolveRealtimeVoiceProviderEntries(cfg?: SkillSetConfig): RealtimeVoiceProviderPlugin[] {
...
export function listRealtimeVoiceProviders(cfg?: SkillSetConfig): RealtimeVoiceProviderPlugin[] {
