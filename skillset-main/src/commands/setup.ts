...
type SetupCommandDeps = {
  ...
  writeConfigFile?: (config: SkillSetConfig) => Promise<void>;
};
...
async function writeDefaultConfigFile(config: SkillSetConfig): Promise<void> {
