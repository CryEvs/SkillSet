...
import { replaceConfigFile, type SkillSetConfig } from "../../config/config.js";
...
async function resolveCatalogChannelEntry(raw: string, cfg: SkillSetConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as SkillSetConfig;
  ...
  // May trigger loadSkillSetPlugins on cache miss (disk scan + jiti import)
