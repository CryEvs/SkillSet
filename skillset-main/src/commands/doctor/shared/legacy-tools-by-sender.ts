...
export function scanLegacyToolsBySenderKeys(cfg: SkillSetConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: SkillSetConfig): {
