...
function hasChannels(cfg: SkillSetConfig): boolean {
  return hasRecord(cfg.channels);
}

function hasPlugins(cfg: SkillSetConfig): boolean {
  return hasRecord(cfg.plugins);
}

function hasPluginLoadPaths(cfg: SkillSetConfig): boolean {
...
function hasExplicitChannelPluginBlockerConfig(cfg: SkillSetConfig): boolean {
...
function hasConfiguredSafeBins(cfg: SkillSetConfig): boolean {
