...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: SkillSetConfig, deps?: BrowserDoctorDeps) => Promise<void>;
};
...
export async function noteChromeMcpBrowserReadiness(cfg: SkillSetConfig, deps?: BrowserDoctorDeps) {
  try {
