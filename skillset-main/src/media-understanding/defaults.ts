...
const configRegistryCache = new WeakMap<SkillSetConfig, Map<string, MediaUnderstandingProvider>>();

function resolveDefaultRegistry(cfg?: SkillSetConfig) {
  if (!cfg) {
...
function resolveConfiguredImageProviderIds(cfg?: SkillSetConfig): string[] {
