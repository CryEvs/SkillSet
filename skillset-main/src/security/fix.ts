...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof SkillSetConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: SkillSetConfig; env: NodeJS.ProcessEnv }): {
  cfg: SkillSetConfig;
  changes: string[];
} {
