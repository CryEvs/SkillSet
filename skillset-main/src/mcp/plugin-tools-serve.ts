/**
 * Standalone MCP server that exposes SkillSet plugin-registered tools
...
function resolveTools(config: SkillSetConfig): AnyAgentTool[] {
...
export function createPluginToolsMcpServer(
  ...
  const server = new Server(
    { name: "skillset-plugin-tools", version: VERSION },
    { capabilities: { tools: {} } },
  );
