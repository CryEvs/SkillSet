...
function getDiagnosticEventsState(): DiagnosticEventsGlobalState {
  const globalStore = globalThis as typeof globalThis & {
    __skillsetDiagnosticEventsState?: DiagnosticEventsGlobalState;
  };
  if (!globalStore.__skillsetDiagnosticEventsState) {
    globalStore.__skillsetDiagnosticEventsState = {
      enabled: true,
      seq: 0,
  ...
  return globalStore.__skillsetDiagnosticEventsState;
}

export function isDiagnosticsEnabled(config?: SkillSetConfig): boolean {
