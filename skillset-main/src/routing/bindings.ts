...
export function listBindings(cfg: SkillSetConfig): AgentRouteBinding[] {
  return listRouteBindings(cfg);
}

export function listBoundAccountIds(cfg: SkillSetConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: SkillSetConfig) {
