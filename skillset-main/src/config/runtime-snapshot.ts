...
let runtimeConfigSnapshot: SkillSetConfig | null = null;
let runtimeConfigSourceSnapshot: SkillSetConfig | null = null;
...
export function getRuntimeConfigSourceSnapshot(): SkillSetConfig | null {
...
export function loadPinnedRuntimeConfig(loadFresh: () => SkillSetConfig): SkillSetConfig {
...
export async function finalizeRuntimeSnapshotWrite(params: {
  nextSourceConfig: SkillSetConfig;
  hadRuntimeSnapshot: boolean;
  hadBothSnapshots: boolean;
  loadFreshConfig: () => SkillSetConfig;
