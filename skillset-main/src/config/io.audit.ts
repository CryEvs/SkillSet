...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.SKILLSET_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.SKILLSET_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.SKILLSET_WATCH_COMMAND),
