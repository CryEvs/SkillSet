...
function buildInputOptions(options: InputOptionsArg): InputOptionsReturn {
  if (process.env.SKILLSET_BUILD_VERBOSE === "1") {
    return undefined;
  }
...
const shouldBuildPrivateQaEntries = process.env.SKILLSET_BUILD_PRIVATE_QA === "1";
...
function shouldStageBundledPluginRuntimeDependencies(packageJson: unknown): boolean {
  return (
    ...
    packageJson !== null &&
    (packageJson as { skillset?: { bundle?: { stageRuntimeDependencies?: boolean } } }).skillset
...
function isPluginSdkSelfReference(id: string): boolean {
  return (
    id === "skillset/plugin-sdk" ||
    id.startsWith("skillset/plugin-sdk/") ||
    id === "@skillset/plugin-sdk" ||
    id.startsWith("@skillset/plugin-sdk/")
  );
}
