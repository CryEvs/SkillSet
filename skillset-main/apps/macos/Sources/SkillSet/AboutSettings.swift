...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/skillset/skillset") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/skillset/skillset")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://skillset.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "SkillSetBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SkillSetBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "SkillSetGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SkillSetGitCommit") as? String) ??
            "unknown"
    }
