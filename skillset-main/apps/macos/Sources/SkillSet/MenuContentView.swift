...
/// Menu contents for the SkillSet menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About SkillSet") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "SkillSet Not Configured"
        case .remote:
            "Remote SkillSet Active"
        case .local:
            "SkillSet Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .skillsetSelectSettingsTab, object: tab)
        }
    }
