...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.skillset", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return SkillSetConfigFile.defaultWorkspaceURL() }
