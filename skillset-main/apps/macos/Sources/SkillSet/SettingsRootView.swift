...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .skillsetSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SkillSetPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SkillSetPaths.stateDirURL.path
...
extension Notification.Name {
    static let skillsetSelectSettingsTab = Notification.Name("skillsetSelectSettingsTab")
}
