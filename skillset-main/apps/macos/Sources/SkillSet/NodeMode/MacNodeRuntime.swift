...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case SkillSetBrowserCommand.proxy.rawValue:
            ...
            case SkillSetLocationCommand.get.rawValue:
            ...
            case SkillSetSystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case SkillSetSystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case SkillSetSystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case SkillSetSystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case SkillSetSystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case SkillSetCanvasA2UICommand.push.rawValue,
             SkillSetCanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func handleBrowserProxyInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        guard SkillSetConfigFile.browserControlEnabled() else {
            return BridgeInvokeResponse(
                id: req.id,
                ok: false,
                error: SkillSetNodeError(
    ...
    private func resolveA2UIHostUrl() async -> String? {
        ...
        return baseUrl.appendingPathComponent("__skillset__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func handleSystemRun(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(SkillSetSystemRunParams.self, from: req.paramsJSON)
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(SkillSetSystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: SkillSetSystemRunParams,
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> SkillSetLocationMode {
    ...
    private static func errorResponse(
        ...
        code: SkillSetNodeErrorCode,
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: SkillSetNodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: SkillSetCanvasSnapshotFormat,
        maxWidth: Int?,
