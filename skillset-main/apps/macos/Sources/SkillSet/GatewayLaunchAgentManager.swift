...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.skillset", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".skillset/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.skillsetCommand(
            subcommand: "gateway",
