...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.skillset", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.skillset", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [SkillSetChatMessage] = messages.compactMap { item in
