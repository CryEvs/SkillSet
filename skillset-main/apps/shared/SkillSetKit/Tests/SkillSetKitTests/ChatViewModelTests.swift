...
private func historyPayload(
    ...
    messages: [AnyCodable] = []) -> SkillSetChatHistoryPayload
{
    SkillSetChatHistoryPayload(
...
private func sessionEntry(key: String, updatedAt: Double) -> SkillSetChatSessionEntry {
    SkillSetChatSessionEntry(
        key: key,
        kind: nil,
        displayName: nil,
        surface: nil,
...
private func sessionEntry(
    ...
    updatedAt: Double,
    model: String?,
    modelProvider: String? = nil) -> SkillSetChatSessionEntry
{
    SkillSetChatSessionEntry(
        key: key,
        kind: nil,
...
private func modelChoice(id: String, name: String, provider: String = "anthropic") -> SkillSetChatModelChoice {
    SkillSetChatModelChoice(modelID: id, name: name, provider: provider, contextWindow: nil)
}

private func makeViewModel(
    sessionKey: String = "main",
    historyResponses: [SkillSetChatHistoryPayload],
    sessionsResponses: [SkillSetChatSessionsListResponse] = [],
    modelResponses: [[SkillSetChatModelChoice]] = [],
    ...
    -> (TestChatTransport, SkillSetChatViewModel)
{
...
private func sendUserMessage(_ vm: SkillSetChatViewModel, text: String = "hi") async {
    await MainActor.run {
        vm.input = text
        vm.send()
    }
...
private final class TestChatTransport: @unchecked Sendable, SkillSetChatTransport {
    private let state = TestChatTransportState()
    private let historyResponses: [SkillSetChatHistoryPayload]
    private let sessionsResponses: [SkillSetChatSessionsListResponse]
    private let modelResponses: [[SkillSetChatModelChoice]]
    ...
    private let stream: AsyncStream<SkillSetChatTransportEvent>
    private let continuation: AsyncStream<SkillSetChatTransportEvent>.Continuation
        ...
        setSessionThinkingHook: (@Sendable (String) async throws -> Void)? = nil)
    {
        ...
        var cont: AsyncStream<SkillSetChatTransportEvent>.Continuation!
    ...
    func events() -> AsyncStream<SkillSetChatTransportEvent> {
        self.stream
    }

    func setActiveSessionKey(_: String) async throws {}

    func requestHistory(sessionKey: String) async throws -> SkillSetChatHistoryPayload {
        ...
        return self.historyResponses.last ?? SkillSetChatHistoryPayload(
            sessionKey: sessionKey,
            sessionId: nil,
            messages: [],
            thinkingLevel: "off")
    ...
    func sendMessage(
        ...
        attachments _: [SkillSetChatAttachmentPayload]) async throws -> SkillSetChatSendResponse
    {
        await self.state.sentRunIdsAppend(idempotencyKey)
        await self.state.sentThinkingLevelsAppend(thinking)
        return SkillSetChatSendResponse(runId: idempotencyKey, status: "ok")
    }
    ...
    func listSessions(limit _: Int?) async throws -> SkillSetChatSessionsListResponse {
        ...
        return self.sessionsResponses.last ?? SkillSetChatSessionsListResponse(
            ts: nil,
            path: nil,
            count: 0,
            defaults: nil,
    ...
    func listModels() async throws -> [SkillSetChatModelChoice] {
    ...
    func emit(_ evt: SkillSetChatTransportEvent) {
...
@Suite struct ChatViewModelTests {
    ...
    @Test func sessionChoicesPreferMainAndRecent() async throws {
        ...
        let sessions = SkillSetChatSessionsListResponse(
            ts: now,
            path: nil,
            count: 4,
            defaults: nil,
    ...
    @Test func sessionChoicesUseResolvedMainSessionKeyInsteadOfLiteralMain() async throws {
        ...
        let sessions = SkillSetChatSessionsListResponse(
            ...
            path: nil,
            count: 2,
            defaults: SkillSetChatSessionsDefaults(
                model: nil,
                contextTokens: nil,
    ...
    @Test func bootstrapsModelSelectionFromSessionAndDefaults() async throws {
        ...
        let sessions = SkillSetChatSessionsListResponse(
            ...
            path: nil,
            count: 1,
            defaults: SkillSetChatSessionsDefaults(model: "openai/gpt-4.1-mini", contextTokens: nil),
            sessions: [
    ...
    @Test func selectingDefaultModelPatchesNilAndUpdatesSelection() async throws {
        ...
        await MainActor.run { vm.selectModel(SkillSetChatViewModel.defaultModelSelectionID) }
        ...
        #expect(await MainActor.run { vm.modelSelectionID } == SkillSetChatViewModel.defaultModelSelectionID)
    }
    ...
    @Test func selectingProviderQualifiedModelDisambiguatesDuplicateModelIDs() async throws {
        ...
        let sessions = SkillSetChatSessionsListResponse(
            ...
            path: nil,
            count: 1,
            defaults: SkillSetChatSessionsDefaults(model: "openrouter/gpt-4.1-mini", contextTokens: nil),
            sessions: [
    ...
    @Test func lateModelCompletionDoesNotReplayCurrentSessionSelectionIntoPreviousSession() async throws {
        let now = Date().timeIntervalSince1970 * 1000
        let initialSessions = SkillSetChatSessionsListResponse(
            ts: now,
            path: nil,
            count: 2,
            defaults: nil,
        ...
        let sessionsAfterOtherSelection = SkillSetChatSessionsListResponse(
            ts: now,
            path: nil,
            count: 2,
            defaults: nil,
    ...
    @Test func explicitThinkingLevelWinsOverHistoryAndPersistsChanges() async throws {
        let history = SkillSetChatHistoryPayload(
            sessionKey: "main",
            sessionId: "sess-main",
            messages: [],
            thinkingLevel: "off")
...
"""]],
        ...
        let vm = await MainActor.run { SkillSetChatViewModel(sessionKey: "main", transport: transport) }
