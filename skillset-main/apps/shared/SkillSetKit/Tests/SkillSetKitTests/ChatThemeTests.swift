...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = SkillSetChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = SkillSetChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
