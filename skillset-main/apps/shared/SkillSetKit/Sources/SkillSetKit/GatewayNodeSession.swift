...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.skillset", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.skillset", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: SkillSetProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
