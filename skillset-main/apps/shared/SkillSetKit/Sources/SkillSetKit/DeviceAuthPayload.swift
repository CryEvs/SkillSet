...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: SkillSetProtocol.AnyCodable]?
    {
        ...
        return [
            "id": SkillSetProtocol.AnyCodable(identity.deviceId),
            "publicKey": SkillSetProtocol.AnyCodable(publicKey),
            "signature": SkillSetProtocol.AnyCodable(signature),
            "signedAt": SkillSetProtocol.AnyCodable(signedAtMs),
            "nonce": SkillSetProtocol.AnyCodable(nonce),
        ]
    }
}
