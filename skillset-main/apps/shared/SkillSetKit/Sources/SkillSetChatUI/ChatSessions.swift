...
public struct SkillSetChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct SkillSetChatSessionsDefaults: Codable, Sendable {
...
public struct SkillSetChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct SkillSetChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: SkillSetChatSessionsDefaults?
    public let sessions: [SkillSetChatSessionEntry]
    ...
    public init(
        ...
        sessions: [SkillSetChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
