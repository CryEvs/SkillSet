...
internal fun buildGatewayDiagnosticsReport(
  ...
  return """
    Help diagnose this SkillSet Android gateway connection failure.
    ...
    - tell me whether `skillset devices list` should show a pending pairing request
    - if more signal is needed, ask for `skillset qr --json`, `skillset devices list`, and `skillset nodes status`
...
internal fun copyGatewayDiagnosticsReport(
  ...
  clipboard.setPrimaryClip(ClipData.newPlainText("SkillSet gateway diagnostics", report))
