...
import ai.skillset.app.ui.mobileAccentBorderStrong
...
import ai.skillset.app.ui.mobileSurface
import ai.skillset.app.ui.mobileText
import ai.skillset.app.ui.mobileTextSecondary
import ai.skillset.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.skillset.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.skillset.app.ui.mobileFontFamily,
