...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = SkillSetLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = SkillSetLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.skillset.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        ...
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your SkillSet agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected SkillSet agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while SkillSet is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for SkillSet. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(SkillSetLocationMode.off.rawValue)
                            Text("While Using").tag(SkillSetLocationMode.whileUsing.rawValue)
                            Text("Always").tag(SkillSetLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while SkillSet is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("SkillSet", value: DeviceInfoHelper.openClawVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = SkillSetLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your SkillSet chat and run /pair approve, then tap Connect again."
        }
