...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.skillset.ios", category: "LiveActivity")
    private var currentActivity: Activity<SkillSetActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = SkillSetActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<SkillSetActivityAttributes>.activities
    ...
    private func updateCurrent(state: SkillSetActivityAttributes.ContentState) {
    ...
    private func connectingState() -> SkillSetActivityAttributes.ContentState {
        SkillSetActivityAttributes.ContentState(
    ...
    private func idleState() -> SkillSetActivityAttributes.ContentState {
        SkillSetActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> SkillSetActivityAttributes.ContentState {
        SkillSetActivityAttributes.ContentState(
