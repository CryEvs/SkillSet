...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.skillset.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to SkillSet", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to SkillSet gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to SkillSet.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "SkillSetShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "SkillSet is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "SkillSet Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("skillset-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
