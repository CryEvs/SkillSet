...
summary: Machine-checked security models for SkillSet’s highest-risk paths.
read_when:
...
This page tracks SkillSet’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that SkillSet enforces its
...
**What this is not (yet):** a proof that “SkillSet is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/skillset-formal-models](https://github.com/vignesh07/skillset-formal-models).
...
```bash
git clone https://github.com/vignesh07/skillset-formal-models
cd skillset-formal-models
