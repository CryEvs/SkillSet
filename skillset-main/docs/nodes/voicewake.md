...
SkillSet treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.skillset/settings/voicewake.json`

Shape:

```json
{ "triggers": ["skillset", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
