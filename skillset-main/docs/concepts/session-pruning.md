...
SkillSet also runs a separate idempotent cleanup for older legacy sessions that
...
SkillSet auto-enables pruning for Anthropic profiles:
...
If you set explicit values, SkillSet does not override them.
