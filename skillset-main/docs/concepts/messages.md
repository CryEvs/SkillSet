...
This page ties together how SkillSet handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. SkillSet keeps a
...
SkillSet separates the **prompt body** from the **command body**:
...
SkillSet can expose or hide model reasoning:
...
SkillSet resolves that behavior by conversation type:
