...
read_when:
  - You want Zalo Personal (unofficial) support in SkillSet
...
Zalo Personal support for SkillSet via a plugin, using native `zca-js` to automate a normal Zalo user account.
