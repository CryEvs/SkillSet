...
summary: "Testing utilities and patterns for SkillSet plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for SkillSet
plugins.
...
**Import:** `skillset/plugin-sdk/testing`
...
} from "skillset/plugin-sdk/testing";
```
...
import { installCommonResolveTargetErrorCases } from "skillset/plugin-sdk/testing";
...
1. **No monolithic root imports** -- `skillset/plugin-sdk` root barrel is rejected
...
SkillSet uses Vitest with V8 coverage thresholds. For plugin tests:
