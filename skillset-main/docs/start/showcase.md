---
title: "Showcase"
description: "Real-world SkillSet projects from the community"
summary: "Community-built projects and integrations powered by SkillSet"
read_when:
  - Looking for real SkillSet usage examples
...
<div className="showcase-hero">
  ...
  <p className="showcase-lead">
    SkillSet projects are not toy demos. People are shipping PR review loops, mobile apps, home automation,
...
<Info>
**Want to be featured?** Share your project in [#self-promotion on Discord](https://discord.gg/clawd) or [tag @skillset on X](https://x.com/skillset).
</Info>
...
<div className="showcase-video-grid">
  <div className="showcase-video-card">
    <div className="showcase-video-shell">
      <iframe
        ...
        title="SkillSet: The self-hosted AI that Siri should have been (Full setup)"
        loading="lazy"
  ...
  <div className="showcase-video-card">
    ...
    <p>A faster pass across real projects, surfaces, and workflows built around SkillSet.</p>
  ...
  <div className="showcase-video-card">
    <div className="showcase-video-shell">
      <iframe
        ...
        title="SkillSet community showcase"
        loading="lazy"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
        allowFullScreen
      />
...
OpenCode finishes the change → opens a PR → SkillSet reviews the diff and replies in Telegram with “minor suggestions” plus a clear merge verdict (including critical fixes to apply first).

  <img src="/assets/showcase/pr-review-telegram.jpg" alt="SkillSet PR review feedback delivered in Telegram" />
</Card>

<Card title="Wine Cellar Skill in Minutes" icon="wine-glass" href="https://x.com/i/status/2010916352454791216">
  **@prades_maxime** • `skills` `local` `csv`

Asked “Robby” (@skillset) for a local wine cellar skill. It requests a sample CSV export + where to store it, then builds/tests the skill fast (962 bottles in the example).

  <img src="/assets/showcase/wine-cellar-skill.jpg" alt="SkillSet building a local wine cellar skill from CSV" />
</Card>
...
Desktop app to manage skills/commands across Agents, Claude, Codex, and SkillSet.
...
Upload to Cloudflare R2/S3 and generate secure presigned download links. Perfect for remote SkillSet instances.
</Card>
...
CLI for Linear that integrates with agentic workflows (Claude Code, SkillSet). Manage issues, projects, and workflows from the terminal. First external PR merged!
</Card>
...
Claude Code discovered and confirmed the purifier controls, then SkillSet takes over to manage room air quality.

  <img src="/assets/showcase/winix-air-purifier.jpg" alt="Winix air purifier control via SkillSet" />
</Card>

<Card title="Pretty Sky Camera Shots" icon="camera" href="https://x.com/signalgaining/status/2010523120604746151">
  **@signalgaining** • `automation` `camera` `skill` `images`

Triggered by a roof camera: ask SkillSet to snap a sky photo whenever it looks pretty — it designed a skill and took the shot.

  <img src="/assets/showcase/roof-camera-sky.jpg" alt="Roof camera sky snapshot captured by SkillSet" />
</Card>

<Card title="Visual Morning Briefing Scene" icon="robot" href="https://x.com/buddyhadry/status/2010005331925954739">
  **@buddyhadry** • `automation` `briefing` `images` `telegram`

A scheduled prompt generates a single "scene" image each morning (weather, tasks, date, favorite post/quote) via an SkillSet persona.
</Card>
...
SkillSet connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>

<Card title="Todoist Skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `automation` `todoist` `skill` `telegram`

Automated Todoist tasks and had SkillSet generate the skill directly in Telegram chat.
</Card>
...
<Card title="xuezh Chinese Learning" icon="language" href="https://github.com/joshp123/xuezh">
  **@joshp123** • `learning` `voice` `skill`
  ...
  Chinese learning engine with pronunciation feedback and study flows via SkillSet.
...
<Card title="Clawdia Phone Bridge" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`
  ...
  Vapi voice assistant ↔ SkillSet HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
<p className="showcase-section-intro">
  Packaging, deployment, and integrations that make SkillSet easier to run and extend.
</p>

<CardGroup cols={2}>

<Card title="Home Assistant Add-on" icon="home" href="https://github.com/ngutman/skillset-ha-addon">
  **@ngutman** • `homeassistant` `docker` `raspberry-pi`
  
  SkillSet gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>
...
<Card title="Nix Packaging" icon="snowflake" href="https://github.com/skillset/nix-skillset">
  **@skillset** • `nix` `packaging` `deployment`
  
  Batteries-included nixified SkillSet configuration for reproducible deployments.
</Card>
...
<p className="showcase-section-intro">
  The physical-world side of SkillSet: homes, sensors, cameras, vacuums, and other devices.
</p>
...
<Card title="GoHome Automation" icon="house-signal" href="https://github.com/joshp123/gohome">
  **@joshp123** • `home` `nix` `grafana`
  ...
  Nix-native home automation with SkillSet as the interface, plus beautiful Grafana dashboards.
...
<Card title="StarSwap Marketplace" icon="star" href="https://star-swap.com/">
  **Community** • `marketplace` `astronomy` `webapp`
  ...
  Full astronomy gear marketplace. Built with/around the SkillSet ecosystem.
</Card>
...
<p className="showcase-section-intro">
  If you are building something interesting with SkillSet, send it over. Strong screenshots and concrete outcomes help.
</p>
...
<Steps>
  <Step title="Share It">
    Post in [#self-promotion on Discord](https://discord.gg/clawd) or [tweet @skillset](https://x.com/skillset)
  </Step>
