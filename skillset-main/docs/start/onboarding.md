---
summary: "First-run setup flow for SkillSet (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give SkillSet">
...
<Step title="CLI">
  ...
  The app can install the global `skillset` CLI via npm, pnpm, or bun.
