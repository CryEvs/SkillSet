...
<Steps>
  ...
  <Step title="Configure SkillSet">
    Point SkillSet at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or SkillSet
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native SkillSet integration with Claude CLI or API keys.
  </Card>
