---
summary: "Use ElevenLabs speech, Scribe STT, and realtime transcription with SkillSet"
read_when:
  - You want ElevenLabs text-to-speech in SkillSet
...
SkillSet uses ElevenLabs for text-to-speech, batch speech-to-text with Scribe
v2, and Voice Call streaming STT with Scribe v2 Realtime.

| Capability               | SkillSet surface                              | Default                  |
| ------------------------ | --------------------------------------------- | ------------------------ |
...
SkillSet sends multipart audio to ElevenLabs `/v1/speech-to-text` with
