---
summary: "Messaging platforms SkillSet can connect to"
read_when:
  - You want to choose a chat channel for SkillSet
...
SkillSet can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- Channels can run simultaneously; configure multiple and SkillSet will route per chat.
