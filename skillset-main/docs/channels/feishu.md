...
> **Requires SkillSet 2026.4.10 or above.** Run `skillset --version` to check. Upgrade with `skillset update`.

<Steps>
  <Step title="Run the channel setup wizard">
  ```bash
  skillset channels login --channel feishu
  ```
...
```bash
skillset pairing list feishu
skillset pairing approve feishu <CODE>
```
...
4. Check logs: `skillset logs --follow`
...
5. Ensure the gateway is running: `skillset gateway status`
6. Check logs: `skillset logs --follow`

### App Secret leaked

1. Reset the App Secret in Feishu Open Platform / Lark Developer
2. Update the value in your config
3. Restart the gateway: `skillset gateway restart`
