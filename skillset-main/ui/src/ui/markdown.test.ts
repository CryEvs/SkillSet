...
describe("toSanitizedMarkdownHtml", () => {
  ...
  describe("explicit protocol links", () => {
    ...
    it("links http:// URLs", () => {
      const html = toSanitizedMarkdownHtml("Visit http://github.com/skillset");
      expect(html).toContain('<a href="http://github.com/skillset"');
    });
    ...
    it("does NOT rewrite explicit markdown links with CJK display text", () => {
      const html = toSanitizedMarkdownHtml("[SkillSet中文](https://docs.skillset.ai)");
      expect(html).toContain('href="https://docs.skillset.ai"');
      expect(html).toContain("SkillSet中文</a>");
    });
