...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.skillset/skillset.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von skillset dashboard --no-open auf Ihrem Desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — mit skillset models auth erneut authentifizieren",
