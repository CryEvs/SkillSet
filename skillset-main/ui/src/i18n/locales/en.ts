...
export const en: TranslationMap = {
  ...
  subtitles: {
    skillset: "SkillSet chat workspace.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from skillset dashboard --no-open on your desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — re-authenticate with skillset models auth",
