...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.skillset/skillset.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde skillset dashboard --no-open en tu escritorio.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — vuelve a autenticarte con skillset models auth",
