...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "skillset.json dosyasını düzenleyin.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Mobilde misiniz? Masaüstünüzde skillset dashboard --no-open komutundan tam URL'yi (#token=... dahil) kopyalayın.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — skillset models auth ile yeniden kimlik doğrulayın",
