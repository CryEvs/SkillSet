...
const WORKER_RUNTIME_STATE = Symbol.for("skillset.testSetupRuntimeState");
const WORKER_RUNTIME_HELPERS = Symbol.for("skillset.testSetupRuntimeHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: SkillSetConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
