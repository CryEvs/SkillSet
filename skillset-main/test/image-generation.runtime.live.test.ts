...
const providerFilter = parseCsvFilter(process.env.SKILLSET_LIVE_IMAGE_GENERATION_PROVIDERS);
const caseFilter = parseCaseFilter(process.env.SKILLSET_LIVE_IMAGE_GENERATION_CASES);
const envModelMap = parseProviderModelMap(process.env.SKILLSET_LIVE_IMAGE_GENERATION_MODELS);
