...
declare global {
  ...
  var __SKILLSET_TEST_REFRESH_OPENAI_CODEX_TOKEN__: ((...args: unknown[]) => unknown) | undefined;
}
...
vi.mock("@mariozechner/pi-ai/oauth", () => ({
  ...
  refreshOpenAICodexToken: vi.fn((...args: unknown[]) =>
    globalThis.__SKILLSET_TEST_REFRESH_OPENAI_CODEX_TOKEN__?.(...args),
  ),
}));
...
process.env.SKILLSET_PLUGIN_MANIFEST_CACHE_MS ??= "60000";
