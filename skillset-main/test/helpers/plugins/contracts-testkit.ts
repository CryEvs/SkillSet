...
import type { SkillSetPluginApi } from "../../../src/plugins/types.js";
...
export function createPluginRegistryFixture(config = {} as SkillSetConfig) {
  return {
    config,
...
export function registerVirtualTestPlugin(params: {
  ...
  register(this: void, api: SkillSetPluginApi): void;
}) {
  registerTestPlugin({
