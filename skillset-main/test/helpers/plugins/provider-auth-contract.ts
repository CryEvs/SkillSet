...
type LoginOpenAICodexOAuth =
  (typeof import("skillset/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("skillset/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("skillset/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("skillset/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("skillset/plugin-sdk/provider-auth-login", async () => {
  const actual = await vi.importActual<typeof import("skillset/plugin-sdk/provider-auth-login")>(
    "skillset/plugin-sdk/provider-auth-login",
  );
  return {
    ...actual,
...
vi.mock("skillset/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("skillset/plugin-sdk/provider-auth")>(
    "skillset/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
