---
name: skillset-secret-scanning-maintainer
description: Maintainer-only workflow for handling GitHub Secret Scanning alerts on SkillSet. Use when Codex needs to triage, redact, clean up, and resolve secret leakage found in issue comments, issue bodies, PR comments, or other GitHub content.
---

# SkillSet Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/skillset/skillset/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/skillset-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/skillset/skillset/issues/63101#issuecomment-xxx",
