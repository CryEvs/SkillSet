...
- Code: `.agents/skills/skillset-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/skillset-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
