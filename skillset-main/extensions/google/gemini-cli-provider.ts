...
import { buildOauthProviderAuthResult } from "skillset/plugin-sdk/provider-auth-result";
...
import { fetchGeminiUsage } from "skillset/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: SkillSetPluginApi) {
