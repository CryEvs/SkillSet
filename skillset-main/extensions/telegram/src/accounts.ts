...
import { formatSetExplicitDefaultInstruction } from "skillset/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "skillset/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.SKILLSET_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: SkillSetConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: SkillSetConfig): string {
...
export function listEnabledTelegramAccounts(cfg: SkillSetConfig): ResolvedTelegramAccount[] {
