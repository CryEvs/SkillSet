import type { ChannelSetupAdapter } from "skillset/plugin-sdk/setup-runtime";
import {
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://skillset.ai",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("skillset logs --follow")}\` (safest)`,
