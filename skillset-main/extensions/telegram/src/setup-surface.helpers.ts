...
export function shouldShowTelegramDmAccessWarning(cfg: SkillSetConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`skillset config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`skillset config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
