...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<SkillSetConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<SkillSetConfig["channels"]>["slack"]>>,
): SkillSetConfig {
  return {
    channels: {
      slack: {
