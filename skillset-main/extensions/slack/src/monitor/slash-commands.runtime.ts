...
type BuildCommandTextFromArgs =
  typeof import("skillset/plugin-sdk/command-auth").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("skillset/plugin-sdk/command-auth").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("skillset/plugin-sdk/command-auth").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("skillset/plugin-sdk/command-auth").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("skillset/plugin-sdk/command-auth").resolveCommandArgMenu;
