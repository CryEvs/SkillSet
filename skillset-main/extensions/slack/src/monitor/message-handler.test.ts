...
vi.mock("skillset/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("skillset/plugin-sdk/channel-inbound")>(
    "skillset/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
