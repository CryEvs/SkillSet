...
// Prefix for SkillSet-generated action IDs to scope our handler
const SKILLSET_ACTION_PREFIX = "skillset:";
...
export function registerSlackInteractionEvents(params: {
  ...
  const modalMatcher = new RegExp(`^${SKILLSET_ACTION_PREFIX}`);

  // Handle SkillSet modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
