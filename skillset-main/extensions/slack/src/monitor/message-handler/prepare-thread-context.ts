import { formatInboundEnvelope } from "skillset/plugin-sdk/channel-inbound";
import type { ContextVisibilityMode } from "skillset/plugin-sdk/config-runtime";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("skillset/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
