...
export function applyOpencodeZenProviderConfig(cfg: SkillSetConfig): SkillSetConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeZenConfig(cfg: SkillSetConfig): SkillSetConfig {
