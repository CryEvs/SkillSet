...
import { hasConfiguredSecretInput } from "skillset/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: SkillSetConfig): Record<string, unknown> | null {
