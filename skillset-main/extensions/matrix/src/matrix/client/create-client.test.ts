...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/skillset-matrix-create-client-test",
    storagePath: "/tmp/skillset-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/skillset-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/skillset-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/skillset-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "skillset-matrix-default-token-hash",
