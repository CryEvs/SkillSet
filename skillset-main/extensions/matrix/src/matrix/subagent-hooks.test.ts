import type { SkillSetPluginApi as MatrixEntryPluginApi } from "skillset/plugin-sdk/channel-entry-contract";
...
vi.mock("skillset/plugin-sdk/conversation-binding-runtime", () => ({
