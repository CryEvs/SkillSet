import { resolveControlCommandGate } from "skillset/plugin-sdk/command-gating";
import {
  evaluateSupplementalContextVisibility,
  resolveChannelContextVisibilityMode,
} from "skillset/plugin-sdk/context-visibility-runtime";
import {
  loadSessionStore,
  resolveSessionStoreEntry,
} from "skillset/plugin-sdk/session-store-runtime";
import { normalizeOptionalString } from "skillset/plugin-sdk/string-coerce-runtime";
import type {
  CoreConfig,
  MatrixRoomConfig,
  MatrixStreamingMode,
...
import { MATRIX_SKILLSET_FINALIZED_PREVIEW_KEY } from "../send/types.js";
...
let acpBindingRuntimePromise:
  | Promise<typeof import("skillset/plugin-sdk/acp-binding-runtime")>
  | undefined;
let sessionBindingRuntimePromise:
  | Promise<typeof import("skillset/plugin-sdk/session-binding-runtime")>
  | undefined;
...
function loadAcpBindingRuntime(): Promise<
  typeof import("skillset/plugin-sdk/acp-binding-runtime")
> {
  acpBindingRuntimePromise ??= import("skillset/plugin-sdk/acp-binding-runtime");
  return acpBindingRuntimePromise;
}

function loadSessionBindingRuntime(): Promise<
  typeof import("skillset/plugin-sdk/session-binding-runtime")
> {
  sessionBindingRuntimePromise ??= import("skillset/plugin-sdk/session-binding-runtime");
...
function buildMatrixFinalizedPreviewContent(): Record<string, unknown> {
  return { [MATRIX_SKILLSET_FINALIZED_PREVIEW_KEY]: true };
}
