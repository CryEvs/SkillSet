import { resolveConfiguredAcpBindingRecord } from "skillset/plugin-sdk/acp-binding-resolve-runtime";
...
import { getSessionBindingService } from "skillset/plugin-sdk/session-binding-runtime";
