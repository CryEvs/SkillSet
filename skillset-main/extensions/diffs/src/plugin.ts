...
import { resolveLivePluginConfigObject } from "skillset/plugin-sdk/config-runtime";
import { resolvePreferredSkillSetTmpDir, type SkillSetPluginApi } from "../api.js";
import {
...
export function registerDiffsPlugin(api: SkillSetPluginApi): void {
  const store = new DiffArtifactStore({
    rootDir: path.join(resolvePreferredSkillSetTmpDir(), "skillset-diffs"),
    logger: api.logger,
  });
