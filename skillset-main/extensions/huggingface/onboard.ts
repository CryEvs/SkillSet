...
export function applyHuggingfaceProviderConfig(cfg: SkillSetConfig): SkillSetConfig {
  return huggingfacePresetAppliers.applyProviderConfig(cfg);
}

export function applyHuggingfaceConfig(cfg: SkillSetConfig): SkillSetConfig {
