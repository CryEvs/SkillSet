...
describe("runCodexAppServerAttempt", () => {
  beforeEach(async () => {
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "skillset-codex-run-"));
  });
  ...
  it("releases completion when a projector callback throws during turn/completed", async () => {
    // Regression for skillset/skillset#67996: a throw inside the projector's
  ...
  it("builds resume and turn params from the currently selected SkillSet model", () => {
