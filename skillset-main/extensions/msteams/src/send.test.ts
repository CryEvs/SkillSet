...
vi.mock("skillset/plugin-sdk/msteams", () => ({
...
vi.mock("skillset/plugin-sdk/text-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("skillset/plugin-sdk/text-runtime")>();
  return {
    ...actual,
