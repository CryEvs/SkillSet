...
import { normalizeSecretInputString, type SecretInput } from "skillset/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: SkillSetConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: SkillSetConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: SkillSetConfig): string {
