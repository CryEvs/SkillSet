...
This package contains the **BlueBubbles external channel plugin** for SkillSet.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `skillset/plugin-sdk` helpers.
