...
const GENERATED_START = "<!-- skillset:wiki:generated:start -->";
const GENERATED_END = "<!-- skillset:wiki:generated:end -->";
const HUMAN_START = "<!-- skillset:human:start -->";
const HUMAN_END = "<!-- skillset:human:end -->";
