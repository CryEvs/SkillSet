...
function resolveGoogleChatAccountImpl(params: { cfg: SkillSetConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: SkillSetConfig) => {
...
function createGoogleChatCfg(): SkillSetConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
