...
import { buildApiKeyCredential } from "skillset/plugin-sdk/provider-auth";
...
export default definePluginEntry({
  ...
  register(api: SkillSetPluginApi) {
    ...
    const resolveCurrentPluginConfig = (config?: SkillSetConfig): OllamaPluginConfig => {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "skillset configure". ' +
        "See: https://docs.skillset.ai/providers/ollama",
    });
  },
});
