...
import type { ModelDefinitionConfig } from "skillset/plugin-sdk/provider-onboard";
import { type SkillSetConfig, withFetchPreconnect } from "skillset/plugin-sdk/testing";
...
describe("Ollama provider", () => {
  const createAgentDir = () => mkdtempSync(join(tmpdir(), "skillset-test-"));
  ...
  async function runOllamaCatalog(params: { config?: SkillSetConfig; env?: NodeJS.ProcessEnv }) {
