...
import { resolveEnvApiKey } from "skillset/plugin-sdk/provider-auth-runtime";
import {
...
function resolveOllamaWebSearchApiKey(config?: SkillSetConfig): string | undefined {
...
function resolveOllamaWebSearchBaseUrl(config?: SkillSetConfig): string {
