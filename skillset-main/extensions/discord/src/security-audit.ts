import { coerceNativeSetting, normalizeAllowFromList } from "skillset/plugin-sdk/channel-policy";
...
} from "skillset/plugin-sdk/native-command-config-runtime";
...
export async function collectDiscordSecurityAuditFindings(params: {
  ...
  addDiscordNameBasedEntries({
    ...
    source: "~/.skillset/credentials/discord-allowFrom.json",
  });
