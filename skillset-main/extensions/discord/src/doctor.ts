...
import { collectProviderDangerousNameMatchingScopes } from "skillset/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: SkillSetConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: SkillSetConfig,
  doctorFixCommand: string,
): { config: SkillSetConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: SkillSetConfig): string[] {
