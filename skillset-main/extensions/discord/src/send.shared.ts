...
import type { ChunkMode } from "skillset/plugin-sdk/reply-chunking";
import { resolveTextChunksWithFallback } from "skillset/plugin-sdk/reply-payload";
import type { RetryRunner } from "skillset/plugin-sdk/retry-runtime";
...
async function resolveDiscordTargetChannelId(
  raw: string,
  opts: DiscordClientOpts & { cfg: SkillSetConfig },
): Promise<{ channelId: string; dm?: boolean }> {
