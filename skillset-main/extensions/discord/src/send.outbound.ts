...
import { recordChannelActivity } from "skillset/plugin-sdk/infra-runtime";
import { maxBytesForKind } from "skillset/plugin-sdk/media-runtime";
import { extensionForMime } from "skillset/plugin-sdk/media-runtime";
import { unlinkIfExists } from "skillset/plugin-sdk/media-runtime";
import type { PollInput } from "skillset/plugin-sdk/media-runtime";
import { resolveChunkMode } from "skillset/plugin-sdk/reply-chunking";
import type { RetryConfig } from "skillset/plugin-sdk/retry-runtime";
import { resolvePreferredSkillSetTmpDir } from "skillset/plugin-sdk/temp-path";
import { convertMarkdownTables, normalizeOptionalString } from "skillset/plugin-sdk/text-runtime";
import { loadWebMediaRaw } from "skillset/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredSkillSetTmpDir();
...
export async function sendVoiceMessageDiscord(
  ...
  let cfg: SkillSetConfig | undefined;
