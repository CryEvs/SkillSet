...
import { listCombinedAccountIds } from "skillset/plugin-sdk/account-resolution";
...
export function listDiscordSetupAccountIds(cfg: SkillSetConfig): string[] {
...
export function resolveDefaultDiscordSetupAccountId(cfg: SkillSetConfig): string {
