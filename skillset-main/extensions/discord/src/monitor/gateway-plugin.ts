...
import { danger } from "skillset/plugin-sdk/runtime-env";
...
export function resolveDiscordGatewayIntents(
  intentsConfig?: import("skillset/plugin-sdk/config-runtime").DiscordIntentsConfig,
): number {
  let intents =
...
function createGatewayPlugin(params: {
  ...
  class SafeGatewayPlugin extends carbonGateway.GatewayPlugin {
    ...
    public override connect(resume = false): void {
      ...
      // firstHeartbeatTimeout race (skillset/skillset#65009, #64011, #63387).
