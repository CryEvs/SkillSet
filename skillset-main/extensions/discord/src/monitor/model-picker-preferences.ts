...
import { normalizeAccountId as normalizeSharedAccountId } from "skillset/plugin-sdk/account-id";
...
import { normalizeProviderId } from "skillset/plugin-sdk/provider-model-shared";
