...
import { resolveGlobalMap } from "skillset/plugin-sdk/global-singleton";
import { createAsyncLock } from "skillset/plugin-sdk/infra-runtime";
import { resolveStateDir } from "skillset/plugin-sdk/memory-core-host-runtime-core";
...
const DIARY_START_MARKER = "<!-- skillset:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- skillset:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "skillset:dreaming:backfill-entry";
