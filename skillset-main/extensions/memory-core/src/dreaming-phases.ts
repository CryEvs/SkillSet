...
import type { SkillSetPluginApi } from "skillset/plugin-sdk/memory-core";
import {
  buildSessionEntry,
  ...
  sessionPathForFile,
} from "skillset/plugin-sdk/memory-core-host-engine-qmd";
import type { MemorySearchResult } from "skillset/plugin-sdk/memory-core-host-runtime-files";
import {
...
const LIGHT_SLEEP_EVENT_TEXT = "__skillset_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__skillset_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- skillset:dreaming:light:start -->",
    endMarker: "<!-- skillset:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- skillset:dreaming:rem:start -->",
    endMarker: "<!-- skillset:dreaming:rem:end -->",
  },
] as const;
 ...
 */
export function registerMemoryDreamingPhases(_api: SkillSetPluginApi): void {
