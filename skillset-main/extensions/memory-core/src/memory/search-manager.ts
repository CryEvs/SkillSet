...
import { checkQmdBinaryAvailability } from "skillset/plugin-sdk/memory-core-host-engine-qmd";
import {
...
import { normalizeAgentId } from "skillset/plugin-sdk/routing";

const MEMORY_SEARCH_MANAGER_CACHE_KEY = Symbol.for("skillset.memorySearchManagerCache");
type Maybe<T> = T | null;
