...
import { resolveUserPath } from "skillset/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "skillset/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall SkillSet (this should install node-llama-cpp): npm i -g skillset@latest"
      : null,
