...
function areWhatsAppAgentReactionsEnabled(params: { cfg: SkillSetConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: SkillSetConfig) {
