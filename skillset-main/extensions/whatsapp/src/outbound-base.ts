...
import { resolveOutboundSendDep, sanitizeForPlainText } from "skillset/plugin-sdk/infra-runtime";
...
function resolveQuoteLookupAccountId(cfg?: SkillSetConfig, accountId?: string | null): string {
