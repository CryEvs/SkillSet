...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "skillset/plugin-sdk/config-runtime";
import { resolveOAuthDir } from "skillset/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: SkillSetConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: SkillSetConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: SkillSetConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: SkillSetConfig): ResolvedWhatsAppAccount[] {
