import { createSubsystemLogger } from "skillset/plugin-sdk/logging-core";
import type { ModelDefinitionConfig } from "skillset/plugin-sdk/provider-model-shared";
import { SELF_HOSTED_DEFAULT_COST } from "skillset/plugin-sdk/provider-setup";
import { fetchWithSsrFGuard, type SsrFPolicy } from "skillset/plugin-sdk/ssrf-runtime";
...
/** Discovers LLM models from LM Studio and maps them to SkillSet model definitions. */
