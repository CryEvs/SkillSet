...
vi.mock("skillset/plugin-sdk/json-store", () => ({
  loadJsonFile,
  saveJsonFile,
}));

vi.mock("skillset/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/skillset-state",
}));

import type { ProviderResolveDynamicModelContext } from "skillset/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/skillset-state/credentials/github-copilot.token.json";
