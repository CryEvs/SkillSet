...
import { createProviderApiKeyAuthMethod } from "skillset/plugin-sdk/provider-auth-api-key";
import { buildProviderReplayFamilyHooks } from "skillset/plugin-sdk/provider-model-shared";
import { MINIMAX_FAST_MODE_STREAM_HOOKS } from "skillset/plugin-sdk/provider-stream-family";
import { fetchMinimaxUsage } from "skillset/plugin-sdk/provider-usage";
...
export function registerMinimaxProviders(api: SkillSetPluginApi) {
