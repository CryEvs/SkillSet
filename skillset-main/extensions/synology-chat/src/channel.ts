/**
 * Synology Chat Channel Plugin for SkillSet.
 *
...
import { waitUntilAbort } from "skillset/plugin-sdk/channel-lifecycle";
import {
...
import { createEmptyChannelDirectoryAdapter } from "skillset/plugin-sdk/directory-runtime";
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "skillset pairing approve synology-chat <code>",
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: SkillSetConfig; id: string }) => Promise<void>;
  };
  security: {
    resolveDmPolicy: (params: { cfg: SkillSetConfig; account: ResolvedSynologyChatAccount }) => {
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to SkillSet",
        order: 90,
      },
      capabilities: {
    ...
    pairing: {
      text: {
        ...
        message: "SkillSet: your access has been approved.",
