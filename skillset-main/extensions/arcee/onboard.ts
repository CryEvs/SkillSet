...
export function applyArceeProviderConfig(cfg: SkillSetConfig): SkillSetConfig {
  return arceePresetAppliers.applyProviderConfig(cfg);
}

export function applyArceeConfig(cfg: SkillSetConfig): SkillSetConfig {
  return arceePresetAppliers.applyConfig(cfg);
}

export function applyArceeOpenRouterConfig(cfg: SkillSetConfig): SkillSetConfig {
