/**
 * Twitch channel plugin for SkillSet.
 *
...
} from "skillset/plugin-sdk/channel-pairing";
import type { SkillSetConfig } from "skillset/plugin-sdk/config-runtime";
import { buildPassiveProbedChannelStatusSummary } from "skillset/plugin-sdk/extension-shared";
import {
 ...
 * for SkillSet. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<ResolvedTwitchAccount> =
  createChatChannelPlugin<ResolvedTwitchAccount>({
    ...
    base: {
      ...
      config: {
        listAccountIds: (cfg: SkillSetConfig): string[] => listAccountIds(cfg),
        resolveAccount: (cfg: SkillSetConfig, accountId?: string | null): ResolvedTwitchAccount => {
        ...
        defaultAccountId: (cfg: SkillSetConfig): string => resolveDefaultTwitchAccountId(cfg),
        isConfigured: (_account: unknown, cfg: SkillSetConfig): boolean =>
      ...
      resolver: {
        resolveTargets: async ({
          ...
          runtime: import("skillset/plugin-sdk/runtime-env").RuntimeEnv;
