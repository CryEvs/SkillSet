...
function mergeZalouserAccountConfig(cfg: SkillSetConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: SkillSetConfig; accountId?: string | null }) {
