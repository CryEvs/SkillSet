...
import { findCatalogTemplate } from "skillset/plugin-sdk/provider-catalog-shared";
import {
  cloneFirstTemplateModel,
  matchesExactOrPrefix,
  type ProviderPlugin,
} from "skillset/plugin-sdk/provider-model-shared";
import { OPENAI_RESPONSES_STREAM_HOOKS } from "skillset/plugin-sdk/provider-stream-family";
...
export function resolveConfiguredOpenAIBaseUrl(cfg: SkillSetConfig | undefined): string {
