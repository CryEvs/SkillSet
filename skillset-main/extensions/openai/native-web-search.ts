...
import { streamWithPayloadPatch } from "skillset/plugin-sdk/provider-stream-shared";
...
function shouldUseOpenAINativeWebSearchProvider(config: SkillSetConfig | undefined): boolean {
