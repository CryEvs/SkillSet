...
import type { ImageGenerationProvider } from "skillset/plugin-sdk/image-generation";
import { isProviderApiKeyConfigured } from "skillset/plugin-sdk/provider-auth";
import { resolveApiKeyForProvider } from "skillset/plugin-sdk/provider-auth-runtime";
import {
  assertOkOrThrowHttpError,
  postJsonRequest,
  resolveProviderHttpRequestConfig,
} from "skillset/plugin-sdk/provider-http";
...
function shouldAllowPrivateImageEndpoint(req: {
  ...
  return process.env.SKILLSET_QA_ALLOW_LOCAL_IMAGE_PROVIDER === "1";
}
