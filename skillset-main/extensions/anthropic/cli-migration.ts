...
type AgentDefaultsModel = NonNullable<NonNullable<SkillSetConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<SkillSetConfig["agents"]>["defaults"]>["models"];
