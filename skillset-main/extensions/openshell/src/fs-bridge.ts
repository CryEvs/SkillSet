...
import { writeFileWithinRoot } from "skillset/plugin-sdk/infra-runtime";
import type {
  SandboxFsBridge,
  SandboxFsStat,
  SandboxResolvedPath,
} from "skillset/plugin-sdk/sandbox";
import { createWritableRenameTargetResolver } from "skillset/plugin-sdk/sandbox";
...
// import, and this helper is not yet part of the `skillset/plugin-sdk/*`
