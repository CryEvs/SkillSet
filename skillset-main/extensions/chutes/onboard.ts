 ...
 */
export function applyChutesProviderConfig(cfg: SkillSetConfig): SkillSetConfig {
 ...
 */
export function applyChutesConfig(cfg: SkillSetConfig): SkillSetConfig {
...
export function applyChutesApiKeyConfig(cfg: SkillSetConfig): SkillSetConfig {
