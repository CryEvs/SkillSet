...
import { mediaKindFromMime } from "skillset/plugin-sdk/media-runtime";
import { withTempDownloadPath } from "skillset/plugin-sdk/temp-path";
...
export async function downloadImageFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "skillset-feishu-img-",
...
export async function downloadMessageResourceFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "skillset-feishu-resource-",
