...
type RegisteredLineCardCommand = Parameters<SkillSetPluginApi["registerCommand"]>[0];

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: SkillSetPluginApi): Promise<RegisteredLineCardCommand> {
