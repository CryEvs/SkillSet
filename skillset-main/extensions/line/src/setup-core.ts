import type { ChannelSetupAdapter, SkillSetConfig } from "skillset/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "skillset/plugin-sdk/setup";
...
export function isLineConfigured(cfg: SkillSetConfig, accountId: string): boolean {
