...
import { __testing as sessionBindingTesting } from "skillset/plugin-sdk/conversation-runtime";
...
describe("buildLineMessageContext", () => {
  ...
  beforeEach(async () => {
    ...
    tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "skillset-line-context-"));
  ...
  it("group peer binding matches raw groupId without prefix (#21907)", async () => {
    ...
    const bindingCfg: SkillSetConfig = {
