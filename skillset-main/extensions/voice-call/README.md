...
Official Voice Call plugin for **SkillSet**.
...
Docs: `https://docs.skillset.ai/plugins/voice-call`
Plugin system: `https://docs.skillset.ai/plugin`

## Install (local dev)

### Option A: install via SkillSet (recommended)
...
```bash
PLUGIN_HOME=~/.skillset/extensions
mkdir -p "$PLUGIN_HOME"
...
- advanced webhook, streaming, and tunnel notes: `https://docs.skillset.ai/plugins/voice-call`
...
`https://docs.skillset.ai/plugins/voice-call#stale-call-reaper`

## TTS for calls

Voice Call uses the core `messages.tts` configuration for
streaming speech on calls. Override examples and provider caveats live here:
`https://docs.skillset.ai/plugins/voice-call#tts-for-calls`
