...
>({
  ...
  resolveParams: (_cfg: SkillSetConfig, api) => ({
    providerId: "xai",
    api,
...
export function applyXaiProviderConfig(cfg: SkillSetConfig): SkillSetConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiResponsesApiConfig(cfg: SkillSetConfig): SkillSetConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiConfig(cfg: SkillSetConfig): SkillSetConfig {
