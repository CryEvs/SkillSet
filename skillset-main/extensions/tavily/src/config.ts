...
export function resolveTavilySearchConfig(cfg?: SkillSetConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: SkillSetConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: SkillSetConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
