...
const DEFAULT_ENTRY = "skillset.mjs";
...
function printUsage(): void {
  console.log(`SkillSet CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: skillset.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "skillset-cli-bench-"));
