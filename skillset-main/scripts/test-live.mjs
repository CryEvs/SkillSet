...
const env = {
  ...process.env,
  SKILLSET_LIVE_TEST: process.env.SKILLSET_LIVE_TEST || "1",
  SKILLSET_LIVE_TEST_QUIET: quietOverride ?? process.env.SKILLSET_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.SKILLSET_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
