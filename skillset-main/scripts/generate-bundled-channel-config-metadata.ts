...
function resolvePackageChannelMeta(source: BundledPluginSource) {
  const skillsetMeta =
    ...
    "skillset" in source.packageJson
      ? (source.packageJson.skillset as Record<string, unknown> | undefined)
      : undefined;
  const channelMeta =
    skillsetMeta &&
    typeof skillsetMeta.channel === "object" &&
    skillsetMeta.channel &&
    !Array.isArray(skillsetMeta.channel)
      ? (skillsetMeta.channel as Record<string, unknown>)
      : undefined;
  return channelMeta;
}
