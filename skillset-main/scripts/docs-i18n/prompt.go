...
- Keep product names in English: SkillSet, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the SkillSet Gateway, use “Gateway 网关”.
