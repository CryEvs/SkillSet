...
show_usage() {
    cat << EOF
clawlog - SkillSet Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View SkillSet logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    SkillSet logs flow through the macOS unified log (subsystem: ai.skillset).
