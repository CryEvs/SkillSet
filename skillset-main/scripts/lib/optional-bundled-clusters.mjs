...
export const OPTIONAL_BUNDLED_BUILD_ENV = "SKILLSET_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.skillset?.install?.npmSpec === "string" &&
    packageJson.skillset.install.npmSpec.trim().length > 0
  );
}
