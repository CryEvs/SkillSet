...
IMAGE_NAME="$(docker_e2e_resolve_image "skillset-pi-bundle-mcp-tools-e2e" SKILLSET_IMAGE)"
CONTAINER_NAME="skillset-pi-bundle-mcp-tools-e2e-$$"
RUN_LOG="$(mktemp -t skillset-pi-bundle-mcp-tools-log.XXXXXX)"
