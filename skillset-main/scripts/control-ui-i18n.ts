...
const ENV_PROVIDER = "SKILLSET_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "SKILLSET_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "SKILLSET_CONTROL_UI_I18N_THINKING";
const ENV_PI_EXECUTABLE = "SKILLSET_CONTROL_UI_I18N_PI_EXECUTABLE";
const ENV_PI_ARGS = "SKILLSET_CONTROL_UI_I18N_PI_ARGS";
const ENV_PI_PACKAGE_VERSION = "SKILLSET_CONTROL_UI_I18N_PI_PACKAGE_VERSION";
const ENV_BATCH_CHAR_BUDGET = "SKILLSET_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "SKILLSET_CONTROL_UI_I18N_PROMPT_TIMEOUT";
...
const DEFAULT_GLOSSARY: readonly GlossaryEntry[] = [
  { source: "SkillSet", target: "SkillSet" },
