...
const codexRepo = process.env.SKILLSET_CODEX_REPO
  ? path.resolve(process.env.SKILLSET_CODEX_REPO)
...
console.log(
  `Codex app-server generated protocol matches SkillSet bridge assumptions: ${schemaRoot}`,
);
